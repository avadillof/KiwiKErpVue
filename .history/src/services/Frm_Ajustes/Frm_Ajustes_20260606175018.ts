...
export function Frm_Ajustes() {
    ...
    return { getRoleSeverity.userDialog, openUserDialog, handleImageLoad, handleImageError, formData, loading, saveData, loadData, provincias, onUploadLogo, logoUrl, baseUrl };
}