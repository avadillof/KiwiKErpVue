...
export function formatHumanDate(date: Date | string | null): string {
    ...
    // 1. Limpieza preventiva del formato de Spring Boot antes de crear el objeto Date
    let dateToParse = date;
    if (typeof dateToParse === 'string' && dateToParse.includes('[')) {
