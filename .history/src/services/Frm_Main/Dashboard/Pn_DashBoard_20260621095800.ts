...
export function DashboardController() {
    ...
    const listaModulos = [
        { id: 'ventas', nombre: 'Ventas', descripcion: 'Facturación, presupuestos control de cobros. Gestión de Clientes. Productos de Ventas', icono: 'pi pi-briefcase', ruta: 'Ventas', colorIcono: '#3b82f6', bgIcono: '#eff6ff' },
