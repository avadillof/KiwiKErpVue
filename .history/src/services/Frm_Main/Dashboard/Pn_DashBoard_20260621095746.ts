...
export function DashboardController() {
    ...
    const listaModulos = [
        { id: 'ventas', nombre: 'Ventas', descripcion: 'Facturación, presupuestos y control de cobros. Gestión de Clientes.', icono: 'pi pi-briefcase', ruta: 'Ventas', colorIcono: '#3b82f6', bgIcono: '#eff6ff' },
