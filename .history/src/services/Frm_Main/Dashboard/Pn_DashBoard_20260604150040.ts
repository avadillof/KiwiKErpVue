...
export function DashboardController() {
    ...
    const listaModulos = [
        ...
        { id: 'ajustes', nombre: 'Ajustes', descripcion: 'Configuración del sistema,parámetros gestión de usuarios.', icono: 'pi pi-cog', ruta: 'Frm_Ajustes', colorIcono: '#6b7280', bgIcono: '#f9fafb' }
    ];
