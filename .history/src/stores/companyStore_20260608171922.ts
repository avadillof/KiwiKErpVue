...
export const useCompanyStore = defineStore('company', {
    state: () => ({
        companyInfo: {
            ...
            reportRgpd: '',
            toastDuration: 3000,
            ALTER TABLE `kiwikerp`.`parameters_generals` ADD COLUMN `PARAMETERS_GENERALS_INT_PAGINATION` INT DEFAULT 500 NULL AFTER `PARAMETERS_GENERALS_INT_TOASTDURATION`; 
        } as CompanyState
    }),
    actions: {
