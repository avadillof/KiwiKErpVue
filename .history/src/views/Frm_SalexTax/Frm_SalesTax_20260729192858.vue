<template>
    <div class="p-4" style="padding-bottom: 80px;margin-bottom: 100px; ">
        ...
        <GenericDataTable style="min-height: 400px;" ref="tableRef" dataKey="pkid" :endpoint="apiUrl" :showPaginator="true" :filterable="true"
            ...
            <Column field="value" header="% Valor" sortable headerStyle="text-align:right" style="width: 5%" sortField="value">
                <template #body="{ data }">
