<template>
    <div class="p-4" style="padding-bottom: 80px;">
        ...
        <GenericDataTable ref="tableRef" dataKey="pkid" :endpoint="apiUrl" :showPaginator="true" :filterable="true"
            ...
            <Column field="value" header="% Valor" sortable headerStyle="text-align:right" style="width: 5%" sortField="active">
                <template #body="{ data }">
            ...
            <Column field="active" header="Activo" style="width: 5%"  sortField="active">
                <template #body="{ data }">
