<template>
  <Dialog v-model:visible="visible" modal header="¿Has olvidado tu contraseña?" :style="{ width: '400px', height:'1100px' }"
    ...
    <div class="reset-container">
      ...
      <div class="kiwik-separator">
        ...
        <Button label="Enviar instrucciones" @click="handleRequestReset" :loading="loading" class="kiwik-btn-auto" />
