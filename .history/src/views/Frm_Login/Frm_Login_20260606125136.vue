<template>
  ...
  <img src="../../assets/logos/corporate.png" alt="FreeLandSite" class="corporate-logo" />
    ...
    <div class="login-grid">
      ...
      <div class="login-card login-card-info">
        <div class="login-header">
          ...
          <div>
            <img v-if="dataEmpresa.txtLogoEmpresa" :src="dataEmpresa.txtLogoEmpresa" class="client-logo" @error="handleImageError"/>
          </div>
        </div>
      </div>
    </div>
