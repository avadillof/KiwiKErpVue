                            ...
                            <div class="grid">
                                ...
                                <div class="col-12 md:col-4">
                                    <FloatLabel>
                                        ...
                                        <KiwiLookup v-model="entity.salesAttributes.salesTarifas"
                                            title="Seleccionar tarifa" placeholder="Seleccione una tarifa..."
                                            :items="tarifas" displayField="salesTarifasDsDescriptionEs"
