                    ...
                    <TabPanel value="0">
                        ...
                        <Panel>
                                ...
                                <div class="col-12 md:col-4 mb-3">
                                    ...
                                    <FloatLabel>                                        
                                        ...
                                        <KiwiLookup 
                                            ...
                                            id="terminoventas" v-model="entity.salesAttributes.salesTermId"
                                            title="Seleccionar la Condición de Pago" placeholder="Condición de pago..."
                                            dataKey="id" :items="terms"
                                ...
                                <div class="col-12 md:col-4">
                                    <FloatLabel>
                                        ...
                                        <KiwiLookup v-model="entity.salesAttributes.salesTarifaId"
                                            :ref="(el) => setRef('tarifasventas', el)"
                                ...
                                <div class="col-12 md:col-4">
                                    <FloatLabel>                                        
                                        ...
                                        <KiwiLookup v-model="entity.salesAttributes.bankId"
                                            ...
                                            dataKey="bankId" :items="banks"
                                            displayField="ibam" :columns="banksColumns">
                                            <template #secondary="{ item }">
                                                <div v-if="item" class="text-500 text-sm">                                                    
                                ...
                                <div class="col-12 md:col-4">
                                    <FloatLabel>                                        
                                         <KiwiLookup v-model="entity.salesAttributes.retentionId"
                                            ...
                                            dataKey="id" :items="retentions"
                                            displayField="description" :columns="retentionsColumns">  
                                            <template #secondary="{ item }">
                                                <div v-if="item" class="text-500 text-sm">                                                    
                            ...
                            <div class="grid mt-4 mt-2">
                                ...
                                <div class="col-12 md:col-6">
                                    <FloatLabel>
                                        <InputText v-model="entity.salesAttributes.sepa" class="w-full" :ref="(el) => setRef('tarifasventas', el)"/>
