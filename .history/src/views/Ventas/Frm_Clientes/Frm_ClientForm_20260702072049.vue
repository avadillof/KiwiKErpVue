                            ...
                            <div class="grid mt-4">
                                ...
                                <div class="col-12 md:col-2">
                                    <FloatLabel>
                                     ...
                                     <InlineMessage v-if="errors.ventasdiapago1" severity="error">
                                            {{ errors.ventasdiapago1 }}
                                    </InlineMessage>                                   
                                </div>
                    ...
                    <TabPanel v-if="entity.isprove" value="1">
                        <Panel>
                            ...
                            <div class="grid mt-4">
                                ...
                                <div class="col-12 md:col-2">
                                    <FloatLabel>
                                        <InputNumber v-model="entity.purchasesAttributes.dayPago1" class="w-full" :ref="(el) => setRef('ventasdiapago1', el)" inputId="minmax" :min="0" :max="100"/>
                                        <label>Día pago 1</label>
                                    </FloatLabel>
                                </div>
...
const validate = async (): Promise<boolean> => {
    ...
    if (entity.value.isclient) {
        ...
        if(entity.value.salesAttributes.dayPago1>31){
            setError('ventasdiapago1', 'El dia de pago no puede ser superior a 31');
            activeTab.value = "0";            
        }
