...
watch(fechaFilterdateUp, (nuevoValor) => {
    ...
    if (fechaFilterdateUp!=null &&   nuevoValor && Array.isArray(nuevoValor) && nuevoValor[0] && nuevoValor[1]) {
...
watch(isClientFilterValue, (nuevoValor) => {
    ...
    if(isClientFilterValue!=null){
        nextTick(() => {            
            tableRef.value.refreshBooleanField('entitieBolClient', nuevoValor);
        });
    }
