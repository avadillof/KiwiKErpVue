            ...
            <Panel>
                ...
                <div class="grid p-fluid mb-12">
                    ...
                    <div class="col-12 md:col-2">
                        <InputGroup>
                            <FloatLabel variant="on" class="w-full">
                                <InputText :ref="(el) => setRef('code', el) " maxlength="45" id="dsCode" v-model="entity.code" class="w-full"
                    ...
                    <div class="col-12 md:col-6">
                        <FloatLabel variant="on" class="w-full">
                            <InputText :ref="(el) => setRef('name', el) " maxlength="120" id="dsName" v-model="entity.name" class="w-full" required />
                ...
                <div class="grid p-fluid mb-12 mt-3">
                    <div class="col-12 md:col-2">
                        <FloatLabel variant="on" class="w-full">
                            <DatePicker  :ref="(el) => setRef('fechaalta', el)"  id="dateUp" v-model="entity.dateUp" class="w-full" showIcon iconDisplay="input"
                                dateFormat="dd/mm/yy" />
...
const validate = async () => {
    ...
    if (entity.value.dateUp == null) {
        setError('fechaalta', 'La Fecha de Alta es obligatoria');
    }

    if (!entity.value.cif?.trim()) {
        setError('cif', 'El CIF es obligatorio');
    } else if (!HelperString.isValidCifNif(entity.value.cif)) {
        setError('cif', 'El CIF tiene un formato no válido');
    }

    if (entity.value.web?.trim() && !HelperString.isValidUrl(entity.value.web)) {
        setError('web', 'El campo Web tiene un valor no válido');
    }

    if (entity.value.email?.trim() && !HelperString.isValidEmail(entity.value.email)) {
        setError('mail', 'El campo Mail tiene un valor no válido');
    }
