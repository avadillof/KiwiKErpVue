<template>
    <div style="background-color: #f9fafb; min-height: 100vh; padding: 20px; margin-bottom: 100px;">
                ...
                <Column field="dateUp" sortable style="width: 15%">
                                ...
                                <template #header>
                                    <div class="flex align-items-center justify-content-between w-full">
                                        ...
                                        <Button  :severity="fechaFilterdateUp ? 'danger' : 'secondary'"  icon="pi pi-filter"  rounded size="small" @click.stop="opDateFilterDateUp($event) " />
                                    </div>
                                </template>
        ...
        <ConfirmDialog />
        <OverlayPanel ref="opDateFilterDateUp" appendTo="body" >
...
const opDateFilterDateUp = (event: any) => {
      opDateFilterDateUp.value?.toggle(event);
};
