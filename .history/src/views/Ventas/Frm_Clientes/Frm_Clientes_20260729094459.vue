<template>
    <div style="background-color: #f9fafb; min-height: 100vh; padding: 20px; margin-bottom: 100px;">
        ...
        <div class="card"
            ...
            <GenericDataTable style="min-height: 400px;" ref="tableRef" dataKey="pkid" selectionMode="single"
                ...
                <Column field="code" sortField="entitieDsCode" header="Código" sortable style="width: 15%"></Column>
                <Column field="name" sortField="entitieDsCode" header="Nombre / Razón Social" sortable style="width: 35%"></Column>
    ...
    <AttachmentsDialog v-model:visible="showAttachments" moduleFolder="ATTACHEMENTS_ENTITIES_DOCUMENTS"
        :title="`Documentos indexados a ${clientSelected?.name ?? ''}`" :entityId="clientSelected?.pkid" />
