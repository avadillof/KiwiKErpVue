                        ...
                        <Panel>
                            ...
                            <div class="grid">
                                ...
                                <div class="col-12 md:col-4 mb-3">
                                    ...
                                    <FloatLabel>
                                        <Select v-model="entity.salesAttributes.salesTermId" :options="terms"
                                            optionLabel="descriptionEs" optionValue="id" class="w-full" />
                                ...
                                <div class="col-12 md:col-4">
                                    <FloatLabel>
                                        <Select v-model="entity.salesAttributes.salesTarifaId" :options="tarifas"
                                            optionLabel="salesTarifasDsDescriptionEs" optionValue="salesTarifasPkId"
                                            class="w-full" />


                                        <AutoComplete v-model="entity.salesAttributes.salesTarifaId" :suggestions="filteredTarifas"
                                            @complete="searchTarifas" optionLabel="salesTarifasDsDescriptionEs"
                                            placeholder="Selecciona tarifa" forceSelection>
                                            <template #item="slotProps">
                                                <div class="flex flex-column">
                                                    <strong>{{ slotProps.item.salesTarifasDsCode }}</strong>
                                                    <span>{{ slotProps.item.salesTarifasDsDescriptionEs }}</span>
                                                    <small>{{ slotProps.item.salesTarifasDsDescriptionUk }}</small>
                                                </div>
                                            </template>
                                        </AutoComplete>
                                ...
                                <div class="col-12 md:col-4">
                                    <FloatLabel>
                                        <Select v-model="entity.salesAttributes.bankId" :options="banks"
                            ...
                            <div class="grid">
                                ...
                                <div class="col-12 md:col-4">
                                    <FloatLabel>
                                        <Select v-model="entity.salesAttributes.retentionId" :options="retentions"
                                            optionLabel="description" optionValue="id" class="w-full" />
...
const filteredTarifas = ref<Tarifa[]>([]);

const searchTarifas = (event: { query: string }) => {
    const query = event.query.toLowerCase();

    filteredTarifas.value = tarifas.value.filter(t =>
        t.salesTarifasDsDescriptionEs.toLowerCase().includes(query) ||
        t.salesTarifasDsCode.toLowerCase().includes(query)
    );
};
...
const createEntity = (): Entity => ({
    ...
    // 👇 MUY IMPORTANTE: inicializar SIEMPRE
    salesAttributes: {
        salesTermId: null,
        salesTarifaId: null,
        retentionId: null,
