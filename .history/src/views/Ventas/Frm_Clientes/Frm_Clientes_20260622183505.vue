...
const applyAllFilters = () => {
    ...
    // Solo añadimos si el filtro de fecha tiene valores reales
    ...
    // Solo añadimos si el filtro booleano NO es null
    if (isClientFilterValue.value !== null) {
        queryParts.push(`[entitieBolClient],${isClientFilterValue.value}`);
    }

    // Si queryParts está vacío, enviamos un string vacío o un indicador de "limpio"
