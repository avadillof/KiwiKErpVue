                                ...
                                <div class="col-12 md:col-4">
                                    <FloatLabel>
                                        ...
                                        <AutoComplete v-model="entity.salesAttributes.salesTarifaId"
                                            ...
                                            <template #item="{ item }: { item: Tarifa }">
                                                <div class="flex flex-column">
                                                    <strong>{{ item.salesTarifasDsCode }}</strong>
                                                    <span>{{ item.salesTarifasDsDescriptionEs }}</span>
                                                    <small>{{ item.salesTarifasDsDescriptionUk }}</small>
                                                </div>
                                            </template>
