...
<div class="grid p-fluid mb-12">
    ...
    <div class="col-12 md:col-2">
        <InputGroup>
            <FloatLabel variant="on" class="w-full">
                <InputText :ref="(el) => setRef('code', el) " maxlength="45" id="dsCode" v-model="entity.code"
                    class="w-full" :disabled="!!entity.pkid" />
    ...
    <div class="col-12 md:col-6">
        <FloatLabel variant="on" class="w-full">
            <InputText :ref="(el) => setRef('name', el) " maxlength="120" id="dsName" v-model="entity.name"
    ...
    <div class="col-12 md:col-2">
        <FloatLabel variant="on" class="w-full">
            <InputText :ref="(el) => setRef('cif', el)" maxlength="38" id="dsCif" v-model="entity.cif" class="w-full" />
...
<div class="grid p-fluid mb-12 mt-3">
    <div class="col-12 md:col-2">
        <FloatLabel variant="on" class="w-full">
            <DatePicker :ref="(el) => setRef('fechaalta', el)" id="dateUp" v-model="entity.dateUp" class="w-full"
                showIcon iconDisplay="input" dateFormat="dd/mm/yy" />
...
<Panel style="margin-top: 20px;">
    ...
    <div class="bg-white p-4 border-round-md shadow-sm border-1 surface-border mb-4">
        ...
        <div class="grid">
            <div class="col-12 md:col-6 mb-2">
                <FloatLabel variant="in">
                    <InputText v-model="entity.address" id="address" maxlength="145" class="w-full" size="small" />
        ...
        <div class="grid">
            ...
            <div class="col-12 md:col-6 mb-2">
                <FloatLabel variant="in">
                    <InputText v-model="entity.address2" id="address2" maxlength="145" class="w-full" size="small" />
        ...
        <div class="grid">
            ...
            <div class="col-12 md:col-1 mb-2">
                <FloatLabel variant="in">
                    <InputText v-model="entity.zipcode" id="zipCode" maxlength="20" class="w-full" size="small" /><label
            ...
            <div class="col-12 md:col-4 mb-2">
                <FloatLabel variant="in">
                    <InputText v-model="entity.city" id="city" maxlength="200" class="w-full" size="small" /><label
            ...
            <div class="col-12 md:col-2 mb-2">
                <FloatLabel variant="in">
                    <InputText v-model="entity.phone" id="phone" maxlength="75" class="w-full" size="small" /><label
        ...
        <div class="grid">
            <div class="col-12 md:col-4 mb-2">
                <InputGroup>
                    ...
                    <Button icon="pi pi-external-link" severity="secondary" @click="openLink" :disabled="!entity.web" />
                </InputGroup>
            ...
            <div class="col-12 md:col-4 mb-2">
                <InputGroup>
                    ...
                    <Button icon="pi pi-envelope" severity="secondary" @click="openEmail" :disabled="!entity.email" />
                </InputGroup>
...
/* =========================
   TYPES
========================= */
type ErrorKey = 'code' | 'name' | 'cif' | 'web' | 'mail' | 'fechaalta';
...
const save = async () => {
    ...
    await axios.post(`${baseUrl}/WebSaveClient`, payload);
