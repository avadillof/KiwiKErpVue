...
const validate = () => {
    errors.value.code = !entity.value.code;
    errors.value.name = !entity.value.name;
    errors.value.cif = !entity.value.cif;

    return !errors.value.code && !errors.value.name && !errors.value.cif;
};
