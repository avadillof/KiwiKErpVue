                ...
                <div class="bg-white p-4 border-round-md shadow-sm border-1 surface-border mb-4">
                    ...
                    <div class="grid">
                        <div class="col-12 md:col-4 mb-2">
                            <InputGroup>
                                <FloatLabel variant="on" class="w-full">
                                    <InputText id="webUrl" v-model="entity.webUrl" class="w-full" />
                                    <label for="webUrl">Sitio Web</label>
                                </FloatLabel>
                                <Button icon="pi pi-external-link" severity="secondary"
                                    @click="window.open(entity.webUrl, '_blank')" :disabled="!entity.webUrl" />
                            </InputGroup>
                        </div>
...
const openLink = () => {
  if (entity.value.webUrl) {
    // Si estás usando TypeScript puro, a veces basta con esto:
    window.open(entity.value.webUrl, '_blank');
  }
}
