        ...
        <Tabs value="0">
            ...
            <TabPanels>
                <TabPanel value="0">
                    <div class="grid p-fluid">
                        <div class="col-12 mb-2">
                            <h4 class="m-0 text-primary"><i class="pi pi-shopping-cart mr-2"></i>Parámetros de Ventas si es Cliente.
                            </h4>
                        </div>
                    </div>
                </TabPanel>
                ...
                <TabPanel value="1">
                    <div class="grid p-fluid">
                        <div class="col-12 mb-2">
                            <h4 class="m-0 text-primary"><i class="pi pi-briefcase mr-2"></i>Parametros de Compras si es Proveedor.
                            </h4>
                        </div>
                    </div>
                </TabPanel>
