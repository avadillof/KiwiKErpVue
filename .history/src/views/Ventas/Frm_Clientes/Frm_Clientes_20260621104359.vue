<template>
    <div style="background-color: #f9fafb; min-height: 100vh; padding: 20px;">
        ...
        <div
            ...
            <div style="display: flex; align-items: center; gap: 15px;">
                <div
                    style="background-color: #e0f2fe; color: #0ea5e9; width: 40px; height: 40px; border-radius: 10px; display: flex; align-items: center; justify-content: center;">
    ...
    <div class="flex flex-column">
        <h5 class="text-primary mt-0 mb-0 flex align-items-center gap-2" style="font-weight: 700; font-size: 1.25rem;">
