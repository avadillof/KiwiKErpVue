                        ...
                        <Panel>
                            ...
                            <template #header>
                                <div class="flex align-items-center gap-2">
                                    ...
                                    <span class="font-bold">Parámetros de Ventas</span>
                                </div>
                            </template>
                            ...
                            <div class="grid">
                                ...
                                <div class="col-12 md:col-4">
                                  ...
                                  <div class="col-12 md:col-4 mb-3"></div>
                                <!-- IMPUESTO -->
                                <div class="col-12 md:col-4">
                                    <FloatLabel>
                                        <Select v-model="entity.salesAttributes.salesTaxId" :options="taxes"
                                            optionLabel="SALES_TAX_DS_DESCRIPTION_SP" optionValue="SALES_TAX_PK_ID"
                                            class="w-full" />
