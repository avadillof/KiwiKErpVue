                            ...
                            <div class="grid">
                                ...
                                <div class="col-12 md:col-4">
                                    <FloatLabel>
                                        ...
                                        <KiwiLookup 
                                            v-model="entity.salesAttributes.salesTarifaId" :items="banks"
                                            dataKey="salesTarifasPkId" displayField="salesTarifasDsDescriptionEs" />

                                        <KiwiLookup v-model="entity.salesAttributes.salesTarifasId"
