                        ...
                        <Panel>
                            ...
                            <div class="grid">
                                ...
                                <div class="col-12 md:col-4">
                                    <FloatLabel>
                                        <Select
    v-model="entity.salesAttributes.salesTarifaId"
    :options="tarifas"
    optionLabel="salesTarifasDsDescriptionEs"
    optionValue="salesTarifasPkId"
    filter
    class="w-full"
>
    <template #option="slotProps">
        <div class="flex justify-between w-full">
            <span class="font-bold">{{ slotProps.option.salesTarifasDsCode }}</span>
            <span>{{ slotProps.option.salesTarifasDsDescriptionEs }}</span>
            <span class="text-color-secondary">
                {{ slotProps.option.coin.shortDescription }}
            </span>
        </div>
    </template>
    ...
    <template #value="slotProps">
        <span v-if="slotProps.value">
            {{ getTarifaDescripcion(slotProps.value) }}
        </span>
    </template>
</Select>


                                        <Dropdown v-model="entity.salesAttributes.salesTarifaId" :options="tarifas"
