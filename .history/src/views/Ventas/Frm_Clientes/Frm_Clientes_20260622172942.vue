<template>
    ...
    <div class="flex flex-column gap-1">
        ...
        <Button label="Todos" icon="pi pi-list" text size="small" 
            :outlined="isClientFilterValue === null"
            class="justify-content-start w-full px-3"
            @click="isClientFilterValue = null; FrmFilterIsClient.hide()" />

        <Button label="Solo Clientes" icon="pi pi-check-circle" text size="small" 
            :outlined="isClientFilterValue === true"
            class="justify-content-start w-full px-3"
            @click="isClientFilterValue = true; FrmFilterIsClient.hide()" />

        <Button label="Solo No Clientes" icon="pi pi-times-circle" text size="small" 
            :outlined="isClientFilterValue === false"
            class="justify-content-start w-full px-3"
