  ...
  <Panel>
    ...
    <div class="grid p-fluid">
      ...
      <div class="col-12 md:col-4">
        <FloatLabel>
          <Select
            v-model="entity.salesAttributes.salesTermId"
            :options="salesTerms"
            optionLabel="SALES_TERM_DS_DESCRIPTION_SP"
            optionValue="SALES_TERM_PK_ID"
            class="w-full"
          />
      ...
      <div class="col-12 md:col-4">
        <FloatLabel>
          <Select
            ...
            optionValue="SALES_TARIFAS_PK_ID"
            class="w-full"
          />
          <label>Tarifa</label>
        </FloatLabel>
      ...
      <div class="col-12 md:col-4">
        <FloatLabel>
          <Select
            v-model="entity.salesAttributes.bankId"
            :options="banks"
            optionLabel="COUNTSBANK_DS_DESC"
            optionValue="COUNTSBANK_PK_ID"
            class="w-full"
          />
      ...
      <div class="col-12 md:col-4">
        <FloatLabel>
          <Select
            v-model="entity.salesAttributes.salesTaxId"
            :options="taxes"
            optionLabel="SALES_TAX_DS_DESCRIPTION_SP"
            optionValue="SALES_TAX_PK_ID"
            class="w-full"
          />
      ...
      <div class="col-12 md:col-4">
        <FloatLabel>
          <Select
            v-model="entity.salesAttributes.retentionId"
            :options="retentions"
            optionLabel="PURCHASES_RETENTION_DS_DESCRIPTION"
            optionValue="PURCHASES_RETENTION_PK_ID"
            class="w-full"
          />
