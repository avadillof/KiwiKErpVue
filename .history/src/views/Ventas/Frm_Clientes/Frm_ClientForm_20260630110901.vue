                        ...
                        <Panel>
                            ...
                            <div class="grid">
                                ...
                                <div class="col-12 md:col-4 mb-3">
                                    ...
                                    <FloatLabel>
                                        <Select v-model="entity.salesAttributes.salesTermId" :options="salesTerms"
                                            optionLabel="SALES_TERM_DS_DESCRIPTION_SP" optionValue="SALES_TERM_PK_ID"
                                            class="w-full" />
                                ...
                                <div class="col-12 md:col-4">
                                    <FloatLabel>
                                        <Select v-model="entity.salesAttributes.salesTarifaId" :options="tarifas"
                                            optionLabel="SALES_TARIFAS_DS_DESCRIPTION_ES"
                                            optionValue="SALES_TARIFAS_PK_ID" class="w-full" />
                                        <label>Tarifa</label>
                                    </FloatLabel>
                                </div>
                                ...
                                <div class="col-12 md:col-4">
                                    <FloatLabel>
                                        <Select v-model="entity.salesAttributes.bankId" :options="banks"
                                            optionLabel="COUNTSBANK_DS_DESC" optionValue="COUNTSBANK_PK_ID"
                                            class="w-full" />
                                ...
                                <div class="col-12 md:col-4">
                                    <FloatLabel>
                                        <Select v-model="entity.salesAttributes.retentionId" :options="retentions"
                                            optionLabel="PURCHASES_RETENTION_DS_DESCRIPTION"
                                            optionValue="PURCHASES_RETENTION_PK_ID" class="w-full" />
...
const loadSalesCatalogs = async () => {
    ...
    const [tarifasRes, termsRes, banksRes, retentionsRes] = await Promise.all([
        axios.get(`${base}/salesTarifas`),
        axios.get(`${base}/salesTerms`),
        axios.get(`${base}/countsBank`),
        axios.get(`${base}/purchasesRetentions`)
    ]);

    tarifas.value = tarifasRes.data || [];
    terminos.value = termsRes.data || [];
    banks.value = banksRes.data || [];
    retentions.value = retentionsRes.data || [];
};
