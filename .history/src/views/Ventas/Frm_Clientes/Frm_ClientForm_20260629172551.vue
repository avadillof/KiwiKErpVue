            ...
            <Panel>
                ...
                <div class="grid p-fluid mb-12">
                    ...
                    <div class="col-12 md:col-6">
                        <FloatLabel variant="on" class="w-full">
                            <InputText maxlength="120" id="dsName" v-model="entity.name" class="w-full" />
...
const save = async () => {
    try {
        ...
        console.log(payload);
        console.log(entity.value.dateUp);
        ...
        let message = 'No se pudo guardar la entidad '+ err.response;

        if (err.response?.status === 409) {

            const backendMsg = err.response.data?.code;

            if (backendMsg === 'DUPLICATE_CODE') {
                message = 'El código ya existe';
            }

            if (backendMsg === 'DUPLICATE_NAME') {
