                            ...
                            <div class="grid">
                                ...
                                <div class="col-12 md:col-4 mb-3">
                                    ...
                                    <FloatLabel>
                                        ...
                                        <KiwiLookup id="terminocompras" v-model="entity.purchasesAttributes.purchasesTermId"
                                ...
                                <div class="col-12 md:col-4">
                                    <FloatLabel>
                                        ...
                                        <KiwiLookup id="tarifascompras"
                                            v-model="entity.purchasesAttributes.purchasesTarifaId"
                                            title="Seleccionar la Condición de Cobro"
                                            placeholder="Condición de cobro..." dataKey="purchasesTarifasPkId" :items="tarifas"
                                            displayField="salesTarifasDsCode" :columns="tarifaColumns"
                                            :ref="(el) => setRef('tarifascompras', el)">
                                            <template #secondary="{ item }">
                                                <div v-if="item" class="text-500 text-sm">
                                                    Vencimiento a {{ item.value }} días
                                                </div>
...
const validate = async (): Promise<boolean> => {
    ...
    if (!valid && firstError) {
        toast.add({
        severity: 'error',
        summary: 'Revise los Datos introducidos.',
