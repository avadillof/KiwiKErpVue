                    ...
                    <template #header>
                        <div class="flex align-items-center justify-content-between w-full">
                            ...
                            <Button :severity="isClientFilterValue !== null ? 'danger' : 'secondary'"
                                icon="pi pi-filter" rounded size="small" @click.stop="opIsclientFilter($event)" />
                        </div>
                    </template>
                    <template #body="slotProps">
                    ...
                    <template #header>
                        <div class="flex align-items-center justify-content-between w-full">
                            ...
                            <Button :severity="isProveFilterValue !== null ? 'danger' : 'secondary'"
                                icon="pi pi-filter" rounded size="small" @click.stop="opIsproveFilter($event)" />
                        </div>
                    </template>
                    <template #body="slotProps">
                        <div class="flex justify-content-center">
        ...
        <OverlayPanel ref="FrmFilterIsProve" appendTo="body" style="width: 200px;">
            <div class="flex flex-column gap-1">
                ...
                <Button label="Proveedores" icon="pi pi-check-circle" text size="small"
                    ...
                    @click="isProveFilterValue = true; FrmFilterIsClient.hide()" />
...
const opIsclientFilter = (event: any) => {
    FrmFilterIsClient.value?.toggle(event);
};

const opIsproveFilter = (event: any) => {
