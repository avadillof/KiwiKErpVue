    ...
    <Dialog v-model:visible="visible" modal :header="entity.pkid ? 'Editar Entidad' : 'Nueva Entidad'"
        ...
        <div style="max-height:80vh; overflow-y:auto">
            ...
            <Panel>
                ...
                <template #header>
                    <p>---------------------</p>
                    <pre>{{ entity.salesAttributes }}</pre>
                    <pre>{{ entity.purchasesAttributes }}</pre>
                            ...
                            <div class="grid">
                                ...
                                <div class="col-12 md:col-4">
                                    <FloatLabel>
                                        ...
                                        <KiwiLookup :modelValue="entity.salesAttributes.bankId"  @update:modelValue="val => entity.salesAttributes.bankId = val"
...
const save = async () => {
    ...
    try {
        console.log('---->', entity.value.salesAttributes);
        await axios.post(
