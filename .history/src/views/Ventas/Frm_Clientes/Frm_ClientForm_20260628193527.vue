        ...
        <Tabs value="0">
            ...
            <TabPanels>
                <TabPanel value="0">
                    <div class="grid p-fluid">
                        <div class="col-12 mb-2">
                            <h4 class="m-0 text-primary"><i class="pi pi-shopping-cart mr-2"></i>Configuración de Ventas
                            </h4>
                        </div>
                        ...
                        <div class="col-12 md:col-6">
                            <FloatLabel variant="on">
                                <InputText id="sales_bank" v-model="entity.salesAttributes.bankAccount"
                                    class="w-full" />
                ...
                <TabPanel value="1">
                    <div class="grid p-fluid">
                        <div class="col-12 mb-2">
                            <h4 class="m-0 text-primary"><i class="pi pi-briefcase mr-2"></i>Configuración de Compras
                            </h4>
                        </div>
