                            ...
                            <div class="grid">
                                ...
                                <div class="col-12 md:col-4 mb-3">
                                    ...
                                    <FloatLabel>
                                        ...
                                        <KiwiLookup v-model="entity.salesAttributes.salesTermId"
                                            title="Seleccionar la Condición de Pago" placeholder="Condición de pago..."
                                            dataKey="salesTarifasPkId" :items="terms"
                                ...
                                <div class="col-12 md:col-4">
                                    <FloatLabel>
                                        ...
                                        <KiwiLookup v-model="entity.salesAttributes.salesTarifaId"
                                            ...
                                            dataKey="salesTarifasPkId" :items="tarifas"
...
onst tarifaColumns: KiwiLookupColumn[] = [
    {
        field: 'salesTarifasDsCode',
        header: 'Código',
        width: '180px'
