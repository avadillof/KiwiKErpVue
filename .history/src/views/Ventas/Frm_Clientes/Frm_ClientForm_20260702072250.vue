                    ...
                    <TabPanel v-if="entity.isclient" value="0">
                        ...
                        <Panel>
                            ...
                            <div class="grid mt-4">
                                ...
                                <div class="col-12 md:col-2">
                                    <FloatLabel>
                                        <InputNumber v-model="entity.salesAttributes.dayPago1" class="w-full" :min="0" :max="31"/>
                                ...
                                <div class="col-12 md:col-2">
                                    <FloatLabel>
                                        <InputNumber v-model="entity.salesAttributes.dayPago2" class="w-full" :min="0" :max="31"/>
                                ...
                                <div class="col-12 md:col-2">
                                    <FloatLabel>
                                        <InputNumber v-model="entity.salesAttributes.dayPago3" class="w-full" :min="0" :max="31"/>
                    ...
                    <TabPanel v-if="entity.isprove" value="1">
                        <Panel>
                                ...
                                <div class="col-12 md:col-4 mb-3">
                                    ...
                                    <FloatLabel>
                                        ...
                                        <KiwiLookup id="terminocompras"
                                            ...
                                            title="Seleccionar la Condición de Pago"
                                            placeholder="Condición de Pago..." dataKey="id" :items="terms"
                                            displayField="descriptionEs" :columns="termsColumns"
                                            :ref="(el) => setRef('terminocompras', el)">
                                            <template #secondary="{ item }">
                                                <div v-if="item" class="text-500 text-sm">
                                                    Vencimiento a {{ item.value }} días
                                                </div>
                            ...
                            <div class="grid mt-4">
                                ...
                                <div class="col-12 md:col-2">
                                    <FloatLabel>
                                        <InputNumber v-model="entity.purchasesAttributes.dayPago1" class="w-full" :min="0" :max="31"/>
                                        <label>Día pago 1</label>
                                    </FloatLabel>
                                </div>
                                ...
                                <div class="col-12 md:col-2">
                                    <FloatLabel>
                                        <InputNumber v-model="entity.purchasesAttributes.dayPago2" class="w-full" :min="0" :max="31"/>
                                        <label>Día pago 2</label>
                                    </FloatLabel>
                                </div>
                                ...
                                <div class="col-12 md:col-2">
                                    <FloatLabel>
                                        <InputNumber v-model="entity.purchasesAttributes.dayPago3" class="w-full" :min="0" :max="31"/>
                                        <label>Día pago 3</label>
                                    </FloatLabel>
                                </div>
...
const validate = async (): Promise<boolean> => {
    ...
    if (entity.value.isclient) {
        ...
        if (!entity.value.salesAttributes.sepa1?.trim()) {
            ...
            setError('sepa2', 'Cuenta SEPA Principal no correcta');
            activeTab.value = "0";
        }
    ...
    if (entity.value.isprove && valid) {
        ...
        if (!entity.value.purchasesAttributes.sepa1?.trim()) {
            ...
            setError('sepapurchases2', 'Cuenta SEPA Principal no correcta');
            activeTab.value = "1";
        }
    }
...
const loadEntity = async (pkid: number) => {
    ...
    entity.value = {
        ...
        purchasesAttributes: {
            purchasesTermId: data.purchasesAttributes?.purchasesTermId ?? null,
            purchasesTarifaId: data.purchasesAttributes?.purchasesTarifaId ?? null,

            retentionId: data.purchasesAttributes?.retentionId ?? null,
            bankId: data.purchasesAttributes?.bankId ?? null,

            sepa: data.purchasesAttributes?.sepa ?? '',
            sepa1: data.purchasesAttributes?.sepa1 ?? '',

            dayPago1: data.purchasesAttributes?.dayPago1 ?? 0,
            dayPago2: data.purchasesAttributes?.dayPago2 ?? 0,
            dayPago3: data.purchasesAttributes?.dayPago3 ?? 0
        },
    };
};
...
========================= */
watch(
    () => [entity.value.isclient, entity.value.isprove],
    ([isClient, isProveedor]) => {
        if (isClient) {
            activeTab.value = '0';
        } else if (isProveedor) {
            activeTab.value = '1';
