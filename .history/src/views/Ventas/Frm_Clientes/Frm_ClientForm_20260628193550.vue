    ...
    <Dialog v-model:visible="visible" modal :header="entity.pkid > 0 ? 'Editar Entidad' : 'Nueva Entidad'"
        ...
        <div class="kiwik-form-container">
                ...
                <div class="col-12 md:col-2">
                    <InputGroup>
                        <FloatLabel variant="on" class="w-full">
                            <InputText maxlength="2" id="dsCode" v-model="entity.dsCode" class="w-full" :disabled="!!entity.pkid" />
            ...
            <div class="grid p-fluid mb-12 mt-3">
                <div class="col-12 md:col-2">
                    <FloatLabel variant="on" class="w-full">
                        <DatePicker id="dateUp" v-model="entity.dateUp" class="w-full" showIcon
                            iconDisplay="input" dateFormat="dd/mm/yy" :disabled="entity.dateUp > 0" />
...
<TabPanels>
    <TabPanel value="0">
        <div class="grid p-fluid">
            <div class="col-12 mb-2">
                <h4 class="m-0 text-primary"><i class="pi pi-shopping-cart mr-2"></i>Configuración de Ventas</h4>
            </div>
            
            <div class="col-12 md:col-6">
                <FloatLabel variant="on">
                    <Select id="sales_tarifa" v-model="entity.salesAttributes.salesTarifasPkId" 
                            :options="tarifas" optionLabel="label" class="w-full" />
                    <label for="sales_tarifa">Tarifa de Venta</label>
                </FloatLabel>
            </div>
            <div class="col-12 md:col-6">
                <FloatLabel variant="on">
                    <InputText id="sales_bank" v-model="entity.salesAttributes.bankAccount" class="w-full" />
                    <label for="sales_bank">Cuenta Bancaria Cobros</label>
                </FloatLabel>
            </div>
        </div>
    </TabPanel>
    ...
    <TabPanel value="1">
        <div class="grid p-fluid">
            <div class="col-12 mb-2">
                <h4 class="m-0 text-primary"><i class="pi pi-briefcase mr-2"></i>Configuración de Compras</h4>
            </div>

            <div class="col-12 md:col-6">
                <FloatLabel variant="on">
                    <Select id="purc_term" v-model="entity.purchasesAttributes.purchasesTermPkId" 
                            :options="terminos" optionLabel="label" class="w-full" />
                    <label for="purc_term">Plazo de Pago</label>
                </FloatLabel>
            </div>
            <div class="col-12 md:col-6">
                <FloatLabel variant="on">
                    <Select id="purc_ret" v-model="entity.purchasesAttributes.retention" 
                            :options="retenciones" optionLabel="label" class="w-full" />
                    <label for="purc_ret">Tipo de Retención IRPF</label>
                </FloatLabel>
            </div>
        </div>
    </TabPanel>
