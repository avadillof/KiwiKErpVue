                            ...
                            <div class="grid">
                                ...
                                <div class="col-12 md:col-4">
                                    <FloatLabel>
                                        ...
                                        <AutoComplete v-model="entity.salesAttributes.salesTarifaId"
                                            :suggestions="filteredTarifas" @complete="searchTarifas"
                                            optionLabel="salesTarifasDsDescriptionEs" placeholder="Selecciona tarifa"
                                            forceSelection>
