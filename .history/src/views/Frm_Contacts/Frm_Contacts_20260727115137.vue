<template>
    ...
    <Frm_ContactForm ref="contactFormRef" :entitieId="props.entitieId" :entitieName='props.entitieName'
...
const menuItems = computed(() => {
    ...
    if (securityStore.hasPermission('ENTI_CON_001')) {
        items.push({
    ...
    if (securityStore.hasPermission(' if (securityStore.hasPermission('ENTI_GEN_0002')) {')) {
