<template>
    ...
    <Dialog v-model:visible="visible" modal
        :header="contact.pkid ? `Datos del Contacto: ${contact.name}` : `Nuevo Contacto para ${props.entitieName}`" :style="{ width: '60rem' }"
...
const validate = async (): Promise<boolean> => {
    ...
    if (contact.value.email && !HelperString.isValidEmail(entity.value.email)) {
