<template>
    ...
    <Dialog v-model:visible="visible" modal
        ...
        <div style="max-height:80vh;overflow-y:auto">
            ...
            <Panel style="margin-top:20px; margin-bottom:0px;">
                ...
                <div class="grid p-fluid">
                    ...
                    <div class="col-12">
                        ...
                        <MultiSelect v-model="contact.departamentos" :options="departamentos" optionLabel="description"
                            optionValue="pkid" display="chip" class="w-full" placeholder="Seleccione departamentos" />
            ...
            <Panel style="margin-top:0px; margin-bottom: 20px;">
...
const save = async () => {
    ...
    const payload = {
        ...contact.value,
        departamentos: contact.value.departamentos.map(id => ({
            departamentoPkid: id,
            mailCopy: false
        }))
    };
