<template>
    ...
    <Dialog v-model:visible="visible" modal :header="contact.pkid ? `Editar Contacto ${contact.name}` : 'Nuevo Contacto'"
                ...
                <div class="grid p-fluid">
                    ...
                    <div class="col-12 md:col-6">
                        ...
                        <FloatLabel variant="on" class="w-full">
                            ...
                            <Select id="cargo" v-model="contact.cargoId" :options="cargos" optionLabel="name"
                    ...
                    <div class="col-12 md:col-4">
                        ...
                        <FloatLabel variant="on" class="w-full">
                            ...
                            <DatePicker id="born" v-model="contact.birth" class="w-full" showIcon
                                dateFormat="dd/mm/yy" />
...
async function open(id: number | null = null,contactSelected.value?.name) {
