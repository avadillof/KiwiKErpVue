<template>
    ...
    <Dialog v-model:visible="visible" modal
            ...
            <Panel style="margin-top:20px" v-if="securityStore.hasPermission('ENTI_CON_0002')">
                ...
                <div class="grid p-fluid">
                    ...
                    <div class="col-12">
                        ...
                        <InlineMessage v-if="errors.direccion1" severity="error">
                            {{ errors.direccion1 }}
                        </InlineMessage>
                    ...
                    <div class="col-12 md:col-2">
                        ...
                        <FloatLabel variant="on">
                            ...
                            <InputText id="postal" v-model="contact.address.postal" maxlength="10" class="w-full" />
                    ...
                    <div class="col-12 md:col-4">
                        ...
                        <FloatLabel variant="on">
                            ...
                            <InputText id="city" v-model="contact.address.city" maxlength="220" class="w-full" />
                    ...
                    <div class="col-12 md:col-4">
                        ...
                        <FloatLabel variant="on">
                            ...
                            <Select v-model="contact.address.province" id="province" :options="provincias"
                                maxlength="200" optionLabel="nombre" optionValue="nombre" class="w-full" size="small"
                                filter :pt="{ root: { style: 'padding-top: 0.35rem' } }" />
                    ...
                    <div class="col-12 md:col-2">
                        ...
                        <FloatLabel variant="on">
                            ...
                            <Select v-model="contact.address.country" id="country" :options="countries" maxlength="120"
                                optionLabel="nombre" optionValue="nombre" class="w-full" size="small" filter
                                :pt="{ root: { style: 'padding-top: 0.35rem' } }" />
        ...
        <template #footer>
            ...
            <Button label="Guardar" icon="pi pi-check" @click="save" v-if="securityStore.hasPermission('ENTI_CON_0002')/>
...
const clearErrors = () => {
    errors.value = {
        name: '', nif: '', email: '', dpto: '', cargo: '', direccion1: ''
    };
};
...
const validate = async (): Promise<boolean> => {
    ...
    if (!contact.value.address?.address1?.trim()) {
        setError('direccion1', 'Obligatorio');
    }
