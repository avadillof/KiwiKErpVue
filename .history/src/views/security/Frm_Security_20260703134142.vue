<template>
    ...
    <div class="p-4" style="padding-bottom: 80px;">
        ...
        <div class="security-page">
            ...
            <div class="card p-4 shadow-2 border-round-xl surface-card surface-border border-1 overflow-hidden relative">
    ...
    <div class="security-header flex align-items-center justify-content-between">
        ...
        <button pButton pRipple icon="pi pi-cog" class="p-button-text p-button-secondary"></button>
    </div>
</div>
