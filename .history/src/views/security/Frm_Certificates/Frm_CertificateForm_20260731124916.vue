<template>
    ...
    <Dialog
        ...
        header="Nuevo Certificado Digital"
        :modal="true"
        :closable="true"
        :draggable="false"
        :style="{ width: '500px' }" class="kiwik-dialog" :dismissableMask="true">
        ...
        <div class="flex flex-column gap-4">
            ...
            <div>
                ...
                <FileUpload
                    ...
                    accept=".p12,.pfx"
                    :maxFileSize="5000000"
                    chooseLabel="Seleccionar certificado"
                    @select="onFileSelect"
                />
