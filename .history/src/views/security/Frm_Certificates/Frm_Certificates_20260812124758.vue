...
import Frm_CertificateForm from '../Frm_Certificates/Frm_CertificateForm.vue';import CertificateUsersDialog from '../Frm_Certificates/CertificateUsersDialog.vue';
...
const openCertificateUsers = () => {
    ...
    console.log('1 - Entrando en openCertificateUsers');

    console.log('2 - selectedCertificate:', selectedCertificate.value);

    const id = selectedCertificate.value?.pkid;

    console.log('3 - id:', id);

    console.log('4 - dialog ref:', certificateUsersDialogRef.value);
