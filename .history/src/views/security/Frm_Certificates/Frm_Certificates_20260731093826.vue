            ...
            >
                <div class="certificate-panel">
                    <GenericDataTable class="h-full" ref="tableRef" dataKey="pkid" :endpoint="apiUrl"
                        ...
                        <Column field="description" header="Descripción" sortable sortField="description" style="width:60%" />

                        <Column field="type" header="Tipo" sortable sortField="type.description" style="width:50%">
