                ...
                <div class="certificate-panel">
                    <GenericDataTable class="h-full" ref="tableRef" dataKey="pkid" :endpoint="apiUrl"
                        ...
                        <template #headerActions>
                            <Button icon="pi pi-ellipsis-v" text rounded @click="openMenuTableGeneric($event)" />

                            <Menu ref="menuTableGeneric" :model="menuItemsTable" popup />
                        </template>
...
const openMenuTableGeneric = (event) => {
    menuTableGeneric.value.toggle(event);
};
