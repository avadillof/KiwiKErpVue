<template>
            ...
            <SplitterPanel :size="75">
                <div class="certificate-panel">
                    <GenericDataTable class="h-full" ref="tableRef" dataKey="pkid" :endpoint="apiUrl"
                        ...
                        <Column field="description" header="Descripción" sortable sortField="description"
                            style="width:30%" />
    ...
    <CertificateUsersDialog ref="certificateUsersDialogRef" />
...
import CertificateUsersDialog from '../Frm_Certificates/CertificateUsersDialog.vue';
...
const menuItems = computed(() => [
    ...
    console.log('Certificado seleccionado:', selectedCertificate.value);
    console.log('PKID enviado:', selectedCertificate.value?.pkid);
...

    {
        ...
        command: () => certificateUsersDialogRef.value.open(selectedCertificate.value?.pkid)
    },
