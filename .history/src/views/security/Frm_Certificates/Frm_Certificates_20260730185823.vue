<template>
    ...
    <div class="p-4" style="padding-bottom: 80px; margin-bottom: 100px;">
        ...
        <Splitter style="height: calc(100vh - 260px);">

            <!-- Tabla -->
            <SplitterPanel :size="70">

                <GenericDataTable class="h-full" ref="tableRef" dataKey="pkid" :endpoint="apiUrl" :showPaginator="true"
                    :filterable="true" :showActions="true" selectionMode="single"
                    ...
                    <Column field="type" header="Tipo" sortable sortField="type.description" style="width:25%">
...
//import Frm_CertificateForm from './Frm_CertificateForm.vue';
