<template>
    ...
    <div class="p-4" style="padding-bottom: 80px;">
        ...
        <Message variant="simple" icon="pi pi-info-circle" severity="success" size="big">
            Configure la securización y accesos a KiwiKERP para el Usaurio seleccionado.
        </Message>
        ...
        <div class="security-page">
            ...
            <div
                ...
                <div class="flex align-items-center gap-2">
                    ...
                    <span class="text-xl font-bold">Seguridad para el Usuario Seleccionado:</span>
...
function volverAlDashboard() {
  ...
  query: {
            tab: tabName // Ejemplo: 'security', 'profile', 'notifications'
        }
}
