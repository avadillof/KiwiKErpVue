<template>
    <div class="security-card">
        ...
        >
            ...
            <i
                class="pi pi-hand-pointer text-6xl mb-4 text-primary"
            ></i>
            ...
            >
                ...
                <template #body="{ data }">
                    ...
                    >
                        ...
                        <span
                            class="text-xs font-bold px-2 py-1 border-round-md"
...
const loadPermissions = (section: any) => {
    ...
    permissions.value = [
        ...
        { desc: 'Crear registros', active: true },
        { desc: 'Eliminar registros', active: false },
        { desc: 'Imprimir', active: true },
        { desc: 'Exportar Excel', active: false },
...
watch(
    () => props.section,
    (section) => loadPermissions(section),
    { immediate: true }
)
</script>
