<template>
    <div class="card p-0 border-round-lg shadow-sm border-1 surface-border h-full flex flex-column overflow-auto " style="margin-bottom: 10px;>
        ...
        <DataTable :value="permissions" scrollable scrollHeight="flex" class="p-datatable-sm custom-header-table">
