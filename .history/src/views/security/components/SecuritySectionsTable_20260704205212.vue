<template>
    ...
    <div class="security-card">
        ...
        >
            ...
            <i
                class="pi pi-lock text-6xl mb-4"
                style="color:#bdbdbd"
            ></i>
        ...
        <!-- SIN MÓDULO -->
        <div
            v-else-if="!props.module"
            class="flex flex-column justify-content-center align-items-center flex-1 text-center p-5"
        >

            <i
                class="pi pi-folder-open text-6xl mb-4 text-primary"
            ></i>
    ...
    (m) => {
        ...
        switch (m.module) {
            ...
            case 'SALES':
                ...
                sections.value = [
                    { id: 1, name: 'General de Ventas', icon: 'pi pi-home' },
                    { id: 2, name: 'Presupuestos', icon: 'pi pi-file-edit' },
                    { id: 3, name: 'Pedidos', icon: 'pi pi-shopping-cart' },
                    { id: 4, name: 'Facturación', icon: 'pi pi-receipt' }
                ]
            ...
            case 'PRODUCTS':
                ...
                sections.value = [
                    { id: 5, name: 'General Productos', icon: 'pi pi-box' },
                    { id: 6, name: 'Familias', icon: 'pi pi-tags' },
                    { id: 7, name: 'Tarifas', icon: 'pi pi-money-bill' }
                ]
