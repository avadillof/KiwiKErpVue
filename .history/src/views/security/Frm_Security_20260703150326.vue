<template>
    <div class="p-4 h-screen flex flex-column" style="padding-bottom: 80px;">
        ...
        <div class="flex-grow-1 border-1 surface-border border-round-lg overflow-auto shadow-sm " style="margin-bottom: 50px;min-height: 1150px;">
            
            <Splitter layout="vertical" class="h-full mt-2 md-2 ml-2 mr-2" style="margin-bottom: 50px;">
