                ...
                <div class="grid p-fluid mb-4">
                    ...
                    <div class="col-12 md:col-5">
                        ...
                        <FloatLabel variant="on" class="w-full">
                            ...
                            <InputText id="descriptionEn" v-model="product.description" maxlength="145"
                                class="w-full" />
                            ...
                            <div class="grid">
                                ...
                                <div class="col-12 md:col-3">
                                    ...
                                    <FloatLabel variant="on">
                                        ...
                                        <InputNumber id="salesPrice" v-model="product.salesPrice" class="w-full"
                                ...
                                <div class="col-12 md:col-3">
                                    ...
                                    <FloatLabel variant="on">
                                        ...
                                        <Select id="salesTax" v-model="product.salesTaxId" :options="salesTaxes"
                                            optionLabel="description" optionValue="pkid" class="w-full" filter />
