                ...
                <div class="grid p-fluid mb-4">
                    ...
                    <div class="col-12 md:col-5">
                        ...
                        <FloatLabel variant="on" class="w-full">
                            ...
                            <InputText id="descriptionEn" v-model="product.description" maxlength="255" class="w-full" />
                    ...
                    <div class="col-12 md:col-5">
                        ...
                        <FloatLabel variant="on" class="w-full">
                            ...
                            <InputText id="descriptionEn" v-model="product.descriptionEn" maxlength="255" class="w-full" />
