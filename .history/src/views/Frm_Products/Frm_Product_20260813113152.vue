            ...
            <Panel>
                ...
                <div class="grid p-fluid mb-4">
                    ...
                    ">
                                ...
                                <div class="flex flex-column align-items-center justify-content-center text-500">
                            ...
                            <Button label="Seleccionar imagen" icon="pi pi-image" severity="secondary" class="mt-3" />
