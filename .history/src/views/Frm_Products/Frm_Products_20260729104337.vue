    ...
    <div style="background-color: #f9fafb; min-height: 100vh; padding: 20px; margin-bottom: 100px;">
        ...
        <div class="card"
            ...
            <GenericDataTable :key="tableKey" endpoint="WebGetProducts" :showPaginator="true" :filterable="true"
                ...
                <Column field="category" sortField="productProductDsDescriptionSp" header="Categoría" sortable />

                <Column field="family" header="Familia" sortable />

                <Column field="uom" header="U.M." sortable />

                <Column field="salePrice" header="Precio Venta" sortable>
                    <template #body="slotProps">
                        {{
                            slotProps.data.salePrice?.toLocaleString('es-ES', {
