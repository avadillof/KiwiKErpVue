                ...
                <div class="grid p-fluid mb-4">
                    ...
                    <div class="col-12 md:col-5">
                        ...
                        <FloatLabel variant="on" class="w-full">
                            ...
                            <InputText id="descriptionEn" v-model="product.description" maxlength="145" class="w-full" />
                    ...
                    <div class="col-12 md:col-5">
                        ...
                        <FloatLabel variant="on" class="w-full">
                            ...
                            <InputText id="descriptionEn" v-model="product.descriptionEn" maxlength="145" class="w-full" />
                ...
                <div class="grid p-fluid mt-3">
                    ...
                    <div class="col-12 md:col-2">
                        ...
                        <FloatLabel variant="on" class="w-full">
                            ...
                            <InputText id="barcode" v-model="product.descriptionEn" maxlength="145" class="w-full" />
