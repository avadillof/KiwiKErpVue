                ...
                <div class="grid p-fluid mb-12">
                    ...
                    <div class="col-12 md:col-4">
                        ...
                        <InputGroup>
                            ...
                            <Button v-if="securityStore.hasPermission('PROSER_GEN_0006') icon="pi pi-id-card" @click="generateCode" :disabled="!!productFamily.pkid"
                                severity="secondary" />
...
const open = async (pkid: number | null) => {
    ...
    try {
        ...
        toast.add({
            severity: 'error',
            summary: 'Error',
            detail: error.response?.data ?? 'No se pudo cargar la Familia de Producto.',
...
const save = async () => {
    ...
    try {
        ...
        toast.add({
            severity: 'error',
            summary: 'Error',
            detail: error.response?.data ?? 'Error inesperado',
            life: companyStore.companyInfo.toastDuration ?? 3000
        });
