<template>
     ...
     <div class="p-4" style="padding-bottom: 80px; margin-bottom: 100px;">
        ...
        <div class="mb-5">
            <Button label="Volver" icon="pi pi-arrow-left" text @click="volver" />
        </div>

        <Toolbar class="mb-3">
            <template #start>
                <Button label="Nueva Familia" icon="pi pi-plus" size="small" variant="text" outlined
                    @click="openNew" />
            </template>
        </Toolbar>
        ...
        >
            ...
            <Column
                ...
                header="Descripción"
                sortable
                sortField="categoriesDsDescriptionsp"
            />
