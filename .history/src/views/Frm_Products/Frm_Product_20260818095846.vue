                        ...
                        <div class="grid mt-1">
                            ...
                            <div class="col-12 md:col-4">
                                ...
                                <InputGroup>
                                    ...
                                    <Button v-if="securityStore.hasPermission('PROSER_GEN_0006') && securityStore.hasPermission('PROSER_GEN_0005') " icon="pi pi-plus" severity="secondary" @click="openNewFamily" />
                            ...
                            <div class="grid">
                                ...
                                <div class="col-12 md:col-3">
                                    ...
                                    <FloatLabel variant="on">
                                        ...
                                        <Select id="purchaseTax" v-model="product.purchaseTaxId" :options="salesTaxes"
                                            optionLabel="description" optionValue="pkid" class="w-full" filter />
...
import Frm_SalexTaxForm from '../Frm_SalesTax/Frm_SalesTaxForm.vue';
...
const loadCatalogs = async () => {
    ...
    try {
        ...
        purchaseTaxes.value = data.purchaseTaxes || [];
...
const filteredCategories = computed(() => {
    ...
    return productCategoryTypes.value.filter(
        category =>
            category.categoryId === product.value.productCategoryId
    );
