                                ...
                                <div class="col-12 md:col-4">
                                    ...
                                    <InputGroup>
                                        ...
                                        <FloatLabel variant="on" class="w-full">
                                            ...
                                            <Select  v-if="securityStore.hasPermission('PROSER_GEN_0078')" id="salesTax" v-model="product.saleTaxId" :options="salesTaxes"
                                                optionLabel="description" optionValue="pkid" class="w-full" filter />
                            ...
                            <div class="grid">
                                ...
                                <div class="col-12 md:col-4">
                                    ...
                                    <InputGroup>
                                        ...
                                        <Button icon="pi pi-plus" severity="secondary" @click="openNewPurchaseTax" />
