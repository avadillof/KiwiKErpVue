                        ...
                        <div class="grid mt-1">
                            ...
                            <div class="col-12 md:col-4">
                                ...
                                <InputGroup>
                                    ...
                                    <Button v-if="securityStore.hasPermission('PROSER_GEN_0006') && securityStore.hasPermission('PROSER_GEN_0006') " icon="pi pi-plus" severity="secondary" @click="openNewFamily" />
