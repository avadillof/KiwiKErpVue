<template>
  <div style="font-family: 'Segoe UI', Arial, sans-serif; background-color: #f9fafb; min-height: 100vh; display: flex; flex-direction: column; justify-content: space-between;">
    ...
    <div>
      ...
      <div style="padding: 40px;">
        ...
        <div style="background-color: #f3f4f6; border: 2px dashed #d1d5db; border-radius: 12px; padding: 45px; text-align: center; color: #9ca3af; margin-bottom: 20px;">
          ...
          <p style="margin: 0; font-size: 0.9rem; font-weight: 500;">
            Los widgets informativos (gráficas de ventas, accesos rápidos y alertas de stock) se cargarán en este space próximamente.
          </p>
        </div>
      </div>
    </div>

    <div style="background-color: white; border-top: 1px solid #e5e7eb; padding: 18px 40px; display: flex; justify-content: space-between; align-items: center; box-shadow: 0 -1px 2px rgba(0,0,0,0.02);">
