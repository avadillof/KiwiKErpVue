        ...
        <TabPanel value="3">
          ...
          <div class="grid mt-1">
                      ...
                      <div class="flex align-items-center gap-3">
                        ...
                        <div>
                          ...
                          <small class="text-color-secondary">
                            Impuestos establecidos que se aplican en los distintos módulos como (Productos y servicios) dentro de los módulos de Compras y Ventas.
                          </small>
                        </div>
                    ...
                    <div class="flex flex-column gap-1">
                      ...
                      <div class="flex align-items-center gap-3">
                        ...
                        <div>
                          ...
                          <small class="text-color-secondary">
                            Gestión de certificados digitales para la firma electrónica y la integración con servicios externos de la Agencia Tributaria
                            como Veri*Factu.
                          </small>
                        </div>
            ...
            <div class="col-12 md:col-3">
              ...
              <div class="tax-card-wrapper" @click="openFamiliaProductos">
...
const openFamiliaProductos = () => {
     router.push('/Frm_FamiliasProductos');
};
