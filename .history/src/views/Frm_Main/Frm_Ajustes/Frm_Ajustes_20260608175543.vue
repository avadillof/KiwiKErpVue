                ...
                <div class="bg-white p-4 border-round-md shadow-sm border-1 surface-border mb-4">
                  ...
                  <div class="grid">
                    ...
                    <div class="col-12 md:col-5 mb-2">
                      <FloatLabel variant="in">                       
                        <InputText v-model="formData.smtpUser" id="smtpUser"  size="small" /><label
                          for="smtpUser">Usuario SMTP</label>
                      </FloatLabel>
                    </div>

                    <div class="col-12 md:col-2 mb-">
                      <FloatLabel variant="in">                        
                        <Password v-model="formData.address" id="smtpPasswordUser" class="w-full" size="small" toggleMask/><label
                          for="smtpPasswordUser">Password de Cuenta</label>
                      </FloatLabel>
                    </div>
