          ...
          <div class="grid">
            <div class="col-12 md:col-3 pr-0 md:pr-4">
              <div
                ...
                <img 
                  v-if="formData.urlLogo" 
                  :key="formData.urlLogo" 
                ...
                <div class="bg-white p-4 border-round-md shadow-sm border-1 surface-border mb-4">
                  ...
                  <div class="grid">
                    ...
                    <div class="col-12 md:col-4 mb-2">
                      <FloatLabel variant="in">
                        <InputText v-model="formData.nameCompany" maxlength="300" id="entitie" class="w-full" size="small" /><label
                    ...
                    <div class="col-12 md:col-2 mb-2">
                      <FloatLabel variant="in">
                        <InputText v-model="formData.cifCompany" id="cif" maxlength="500" class="w-full" size="small" /><label
                          for="cif">NIF/CIF</label>
                      </FloatLabel>
                    </div>
                    <div class="col-12 md:col-4 mb-2">
                      <FloatLabel variant="in">
                        <InputText v-model="formData.email" id="email" maxlength="255" class="w-full" size="small" /><label
                          for="email">Email</label>
                      </FloatLabel>
                    </div>
                    <div class="col-12 md:col-2 mb-2">
                      <FloatLabel variant="in">
                        <InputText v-model="formData.phone" id="phone" maxlength="50" class="w-full" size="small" /><label
                ...
                <div class="bg-white p-4 border-round-md shadow-sm border-1 surface-border mb-4">
                  ...
                  <div class="grid">
                    <div class="col-12 md:col-6 mb-2">
                      <FloatLabel variant="in">
                        <InputText v-model="formData.address" id="address" maxlength="500" class="w-full" size="small" /><label
                          for="address">Calle / Avenida</label>
                      </FloatLabel>
                    </div>
                    <div class="col-12 md:col-2 mb-2">
                      <FloatLabel variant="in">
                        <InputText v-model="formData.addressNumber" id="addressNumber" maxlength="20" class="w-full" size="small" />
                        <label for="addressNumber">Número</label>
                      </FloatLabel>
                    </div>
                    <div class="col-12 md:col-4 mb-2">
                      <FloatLabel variant="in">
                        <Select v-model="formData.province" id="province" :options="provincias" maxlength="200" optionLabel="nombre"
                          optionValue="nombre" class="w-full" size="small" filter
                    ...
                    <div class="col-12 md:col-2 mb-2">
                      <FloatLabel variant="in">
                        <InputText v-model="formData.zipCode" id="zipCode" maxlength="20" class="w-full" size="small" /><label
                          for="zipCode">CP</label>
                      </FloatLabel>
                    </div>
                    <div class="col-12 md:col-4 mb-2">
                      <FloatLabel variant="in">
                        <InputText v-model="formData.city" id="city" maxlength="200" class="w-full" size="small" /><label
...
import Frm_SalesTax from '@/views/salesTax/Frm_SalesTax.vue'
