<template>
    ...
    <img v-else-if="formData.pkid > 0" 
         :src="getProfilePhotoUrl()" class="w-full h-full object-cover" 
         @error="formData.profilePhoto = null" /> <i v-else class="pi pi-user text-5xl text-gray-300"></i>
</div>
