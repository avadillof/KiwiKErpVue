                      ...
                      <div class="flex align-items-center gap-3">
                        ...
                        <div>
                          ...
                          <small class="text-color-secondary">
                            Impuestos que se aplican en Productos y servicios dentro de los módulos de Compras y Ventas.
                          </small>
                        </div>
        ...
        <div class="flex flex-column gap-1">
          ...
          <div class="flex align-items-center gap-3">
            ...
            <div>
              ...
              <small class="text-color-secondary">
                Gestión de certificados digitales utilizados por KiwiKERP para la firma electrónica y la integración con servicios externos.
              </small>
            </div>
