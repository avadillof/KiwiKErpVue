        ...
        <div class="kiwik-form-container grid-layout">
            ...
            <div class="col-right flex flex-column gap-4">
                ...
                <div class="col-12 md:col-5">
                    <InputGroup>
                        <FloatLabel variant="on" class="w-full">
                            <InputText maxlength="35" id="user_code" v-model="formData.userDsCode" class="w-full"
                ...
                <FloatLabel variant="on" class="w-full">
                    <InputText id="user_name" maxlength="125" v-model="formData.name" class="w-full" />
                    <label for="user_name">Nombre Completo</label>
                </FloatLabel>

                <FloatLabel variant="on" class="w-full">
                    <InputText id="user_email" maxlength="100" v-model="formData.email" class="w-full" />
                ...
                <FloatLabel variant="on" class="w-full">
                    <Password id="user_pass" maxlength="255" v-model="formData.password" class="w-full" toggleMask :feedback="false" />
