<template>
  ...
  <img v-if="formData.urlLogoCompany" 
       :key="formData.urlLogoCompany" 
       :src="formData.urlLogoCompany"
       style="max-height: 120px; object-fit: contain;" 
       @error="handleImageError" 
       @load="handleImageLoad" /> <i v-else class="pi pi-image text-5xl text-400 mb-3"></i>
