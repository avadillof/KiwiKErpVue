...
import Frm_FamiliaProductos  from '@/views/Frm_Products/Frm_FamiliasProductos/Frm_FamiliaProductos.vue';
...
const familiasProductosRef = ref();
...
const openFamiliasProductos = () => {
    familiasProductosRef.value?.open();
};
