          ...
          <div class="grid">
            ...
            <div class="col-12 md:col-3 pr-0 md:pr-4">
              ...
              <div
                ...
                <img v-if="formData.urlLogoCompany" :key="formData.urlLogoCompany" :src="formData.urlLogoCompany"
              ...
              <div class="mt-4">
                <FloatLabel variant="in">
                  <InputText v-model="formData.sloganCompany" id="slogan" class="w-full" size="small" />
              ...
              <div class="p-5 surface-50 border-round border-1 surface-border">
                ...
                <div class="bg-white p-4 border-round-md shadow-sm border-1 surface-border mb-4">
                  ...
                  <div class="grid">
                    <div class="col-12 md:col-4 mb-2">
                      <FloatLabel variant="in">
                        <InputText v-model="formData.nameCompany" id="entitie" class="w-full" size="small" /><label
                          for="entitie">Nombre Entidad</label>
                      </FloatLabel>
                    </div>
                    <div class="col-12 md:col-2 mb-2">
                      <FloatLabel variant="in">
                        <InputText v-model="formData.cifCompany" id="cif" class="w-full" size="small" /><label
                ...
                <div class="bg-white p-4 border-round-md shadow-sm border-1 surface-border mb-4">
                  ...
                  <div class="grid">
                    ...
                    <div class="col-12 md:col-4 mb-2">
                      <FloatLabel variant="in">
                        <Select v-model="formData.province" id="province" :options="provincias" optionLabel="nombre"
...
<TabPanel value="2">
  <div class="flex justify-content-end mb-3">
    <Button label="Nuevo Usuario" icon="pi pi-plus" @click="openNewUserDialog" />
  </div>
  ...
  <Dialog v-model:visible="userDialog" modal header="Detalles de Usuario">
     <Tabs>
       <TabList>
         <Tab value="0">Datos</Tab>
         <Tab value="1">Permisos</Tab> </TabList>
       <TabPanels>
         <TabPanel value="0"><UserForm /></TabPanel>
         <TabPanel value="1"><PermissionSettings /></TabPanel>
       </TabPanels>
     </Tabs>
  </Dialog>
</TabPanel>
...
const { formData, loading, saveData, provincias, loadData, onUploadLogo, baseUrl, handleImageError, handleImageLoad } = Frm_Ajustes();
