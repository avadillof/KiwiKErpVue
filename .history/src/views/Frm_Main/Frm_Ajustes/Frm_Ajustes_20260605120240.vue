          ...
          <div class="grid">
            ...
            <div class="col-12 md:col-3 pr-0 md:pr-4">
              ...
              <div
                ...
                <FileUpload mode="basic" name="logo" :url="`${assetsUrl}/upload-logo`" accept="image/*"
                  :maxFileSize="1000000" @upload="onUploadLogo" chooseLabel="Cambiar Logo" class="mt-3" />
              </div>
...
const assetsUrl = baseUrl.replace(':8080', ':8083');
const router = useRouter();
const { formData, loading, saveData, provincias, loadData,onUploadLogo } = Frm_Ajustes();
