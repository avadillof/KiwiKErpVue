...
<div class="col-12 mt-3">
  <Message severity="warn">
    <div class="flex align-items-center gap-2">
      ...
      <span class="font-medium">Texto de Protección de Datos (RGPD).</span>
    </div>
  </Message>

  <div class="col-12 mt-3 bg-yellow-100 border-1 border-yellow-200 p-3 border-round">
   Si ves este fondo amarillo, el problema es que tu CSS está bloqueando los estilos de PrimeVue.
</div>
</div>
                  </div>
                </div>
