        ...
        <TabPanel value="3">
          ...
          <div class="grid mt-1">
                      ...
                      <div class="flex align-items-center gap-3">
                        ...
                        <div>
                          ...
                          <small class="text-color-secondary">
                            Impuestos establecidos que se aplican en los distintos módulos como (Productos y servicios)
                            dentro de los módulos de Compras y Ventas.
                          </small>
                        </div>
                      ...
                      <div class="flex align-items-center gap-3">
                        ...
                        <div>
                          ...
                          <small class="text-color-secondary">
                            ...
                            externos de la Agencia Tributaria
                            como Veri*Factu.
                          </small>
                        </div>
            ...
            <div class="col-12 md:col-3">
              ...
              <div class="tax-card-wrapper" @click="openFamiliasProductos">
                    ...
                    <div class="flex flex-column gap-1">
                      ...
                      <div class="flex align-items-center gap-3">
                        ...
                        <div>
                          ...
                          <small class="text-color-secondary">
                            Gestión y mantenimiento de las distintas Familias de Productosde KiwikERP a las que perenecerán los distintos productos y Servicios.
                      ...
                      <div class="flex justify-content-end">
                        <Button label="Gestionar" icon="pi pi-bookmark" iconPos="right" text size="small"
                          style="padding: 5px 10px; font-weight: 600; background: transparent; border: none; border-radius: 6px; cursor: pointer; color: #9cc10a; transition: background-color 0.2s, color 0.2s;"
                          onmouseover="this.style.backgroundColor='#f9fbe7'; this.style.color='#648506';"
                          onmouseout="this.style.backgroundColor='transparent'; this.style.color='#9cc10a';"
                          @click="openFamiliasProductos" />
                      </div>
