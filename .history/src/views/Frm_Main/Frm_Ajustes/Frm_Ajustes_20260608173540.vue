        ...
        <TabPanel value="1">
          <div class="grid">
            <div class="col-12 md:col-12 mt-4 md:mt-0">
              ...
              <div class="field">
                  <label for="pagination">Paginación (Registros por página)</label>
                  <InputNumber 
                      id="pagination" 
                      v-model="formData.paginationTable" 
                      :min="1" 
                      :max="5000" 
                      showButtons 
                      fluid 
                  />
                  <small>Determina la cantidad de registros por página en las tablas del sistema.</small>
              </div>
