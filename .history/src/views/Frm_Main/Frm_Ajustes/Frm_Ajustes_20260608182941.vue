          ...
          <div class="grid">
            <div class="col-12 md:col-3 pr-0 md:pr-4">
              <div
                ...
                style="height: 200px;">
                <img v-if="formData.urlServer" :key="formData.urlServer" :src="formData.urlServer"
                ...
                <div class="bg-white p-4 border-round-md shadow-sm border-1 surface-border mb-4">
                  ...
                  <div class="grid">
                    ...
                    <div class="col-12 md:col-3 mb-1">
                      <FloatLabel variant="in">                        
                        <Password v-model="formData.smtpPasswordCountSmtp" id="smtpPasswordUser" class="w-full" size="small" toggleMask/><label
                          for="smtpPasswordUser">Password</label>
                      </FloatLabel>
                    </div>
              ...
              <div class="p-5 surface-50 border-round border-1 surface-border">
                ...
                <div class="bg-white p-4 border-round-md shadow-sm border-1 surface-border">
                  ...
                  <div class="grid">
                    ...
                    <div class="col-12 md:col-6 mt-3">
                      <FloatLabel variant="in">
                        <InputText v-model="formData.urlServer" id="urlServer" class="w-full" size="small" />
                        <label for="urlServer">Url BackServer</label>
                      </FloatLabel>
                    </div>
                  </div>
                </div>
