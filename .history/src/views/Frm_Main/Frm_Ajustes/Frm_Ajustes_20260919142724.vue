<template>
  <main class="settings-page ajustes-page">
    ...
    <Tabs v-model:value="activeTab">
          ...
          <div class="grid">
            ...
            <div class="col-12 md:col-9 mt-4 md:mt-0">
              <div class="p-5 surface-50 border-round border-1 surface-border">
                ...
                <div class="bg-white settings-section-last p-4 border-round-md shadow-sm border-1 surface-border mb-4">
                  <h5 class="text-primary mt-0 mb-4 flex align-items-center gap-2">
          ...
          <div class="grid">
            <div class="col-12 md:col-12 mt-4 md:mt-0">
              <div class="p-5 surface-50 border-round border-1 surface-border">
                ...
                <div class="bg-white settings-section-last p-4 border-round-md shadow-sm border-1 surface-border">
      ...
      <!-- Única zona de guardado para los ajustes generales.
           Empresa y Preferencias comparten el mismo formData/saveData. -->
