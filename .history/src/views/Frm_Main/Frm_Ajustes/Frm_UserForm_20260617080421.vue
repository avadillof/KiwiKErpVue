<template>
    <Dialog v-model:visible="visible" modal :header="formData.pkid > 0 ? 'Editar Usuario' : 'Nuevo Usuario'"
        ...
        <div class="kiwik-form-container grid-layout">
            ...
            <div class="col-right flex flex-column gap-4">
                ...
                <FloatLabel variant="on" class="w-full">
                    <Select id="user_group" v-model="formData.groupKyId" :options="groupOptions" optionLabel="label" optionValue="value"
                        class="w-full" />
    ...
    <Dialog v-model:visible="cameraVisible" modal header="Capturar Foto" 
    :style="{ width: '400px' }" :dismissableMask="true" class="kiwik-dialog">
    
    <div class="flex flex-column">
        <video ref="videoRef" autoplay playsinline class="w-full border-round shadow-2" 
            style="background: #000; min-height: 250px;"></video>
