...
// Importamos los componentes de PrimeVue necesarios para la barra superior
import Card from 'primevue/card';
import Button from 'primevue/button';
import Divider from 'primevue/divider';
import Avatar from 'primevue/avatar';
import OverlayBadge from 'primevue/overlaybadge'; // <-- IMPORTANTE: Componente para superponer el número de mensajes
...
export default defineComponent({
  ...
  components: {
    ...
    Divider,
    Avatar,
    OverlayBadge // <-- Registro obligatorio
  },
  
  setup(props, context) {
    if (Frm_MainController.setup !== undefined) {
      return Frm_MainController.setup(props, context);
    }
    return {};
  }
});
