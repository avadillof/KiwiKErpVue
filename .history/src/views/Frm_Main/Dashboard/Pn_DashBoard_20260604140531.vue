<template>
  <div style="padding: 20px;">
    ...
    <div style="margin-bottom: 35px;">      
      ...
      <p style="color: #6b7280; margin: 5px 0 0 0; font-size: 1.1rem;">
    ...
    <div style="display: grid; grid-template-columns: repeat(auto-fill, minmax(240px, 1fr)); gap: 25px; margin-bottom: 40px;">
      ...
      >
        ...
        <template #content>
          <p style="margin: 0; color: #6b7280; font-size: 0.95rem; font-weight: 500; line-height: 1.5; min-height: 45px;">
            {{ modulo.descripcion }}
          </p>
        </template>
...
export default defineComponent({
  ...
  setup() {
    ...
    const listaModulos = [
        ...
        { id: 'ajustes', nombre: 'Ajustes', descripcion: 'Configuración del sistema y gestión de usuarios.', icono: 'pi pi-cog', ruta: 'Frm_Ajustes', colorIcono: '#6b7280', bgIcono: '#f9fafb' }
    ];

    const modulosVisibles = computed(function() {
      return listaModulos.filter(function(modulo) {
        // Lógica de seguridad:
        // 1. Ajustes solo para admins
        ...
        // 2. Resto de módulos disponibles si está autenticado
