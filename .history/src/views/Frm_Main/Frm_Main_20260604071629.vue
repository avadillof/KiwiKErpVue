...
// Importamos el tipo de Componente de Vue para ayudar a TypeScript
...
export default defineComponent({
  ...
  setup(props, context) {
    // Definimos explícitamente que Frm_Main es un Componente
    const controller = Frm_Main as ComponentOptions;
    
    // Ahora accedemos a setup de forma segura
    if (controller.setup) {
