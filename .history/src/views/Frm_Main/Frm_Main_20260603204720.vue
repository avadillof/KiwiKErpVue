  ...
  <div style="padding: 40px; font-family: 'Segoe UI', Arial, sans-serif; background-color: #f9fafb; min-height: 100vh;">
    ...
    <div style="margin-bottom: 35px;">
      ...
      <p style="color: #6b7280; margin: 5px 0 0 0;">
        Bienvenido de nuevo, <span style="color: #9cc10a; font-weight: bold;">{{ userName }}</span>. Selecciona un módulo para empezar a trabajar.
      </p>
    </div>
...
export default defineComponent({
  ...
  // Delegamos de forma estricta la inicialización al controlador externo
  setup(props, context) {
