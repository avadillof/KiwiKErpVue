<template>
  <div style="font-family: 'Segoe UI', Arial, sans-serif; background-color: #f9fafb; min-height: 100vh; display: flex; flex-direction: column; overflow: hidden;">
    
    <div style="background-color: white; border-bottom: 1px solid #e5e7eb; padding: 15px 40px; display: flex; justify-content: space-between; align-items: center; box-shadow: 0 1px 2px rgba(0,0,0,0.03); z-index: 10;">
    ...
    <div style="flex: 1; overflow-y: auto; padding: 40px;">
      ...
      <div style="background-color: #f3f4f6; border: 2px dashed #d1d5db; border-radius: 12px; padding: 45px; text-align: center; color: #9ca3af; margin-bottom: 10px;">
    ...
    <div style="background-color: white; border-top: 1px solid #e5e7eb; padding: 15px 40px; display: flex; justify-content: space-between; align-items: center; box-shadow: 0 -2px 5px rgba(0,0,0,0.03); position: sticky; bottom: 0; z-index: 10;">
      ...
      <div style="display: flex; align-items: center; gap: 10px;">
        ...
        <span style="font-size: 0.85rem; color: #6b7280; font-weight: 600;">
          Entidad: <span style="color: #374151;">{{ empresaNombre }}</span>
        </span>
      </div>
      ...
      <div style="display: flex; align-items: center; gap: 15px; font-size: 0.85rem; color: #9ca3af; font-weight: 500;">
        ...
        <div style="display: flex; align-items: center; gap: 8px;">
          <img 
            src="../../assets/logos/LogTras.png" 
            alt="KiwiKERP Mini Logo" 
            style="height: 18px; width: auto; object-fit: contain; opacity: 0.85;" 
          />
        ...
        <span>&copy; {{ erpInfo.copyright }} Todos los derechos reservados.</span>
      </div>
...
export default defineComponent({
  ...
  setup(props, context): Record<string, any> {
    if (Frm_MainController.setup !== undefined) {
      return Frm_MainController.setup(props, context) as any;
    }
    return {};
  }
});
