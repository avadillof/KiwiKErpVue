...
import Frm_FamiliasProductos from './views/Frm_Products/Frm_FamiliasProductos/Frm_FamiliaProductos.vue
...
const routes = [
  ...
  },
  {
    ...
    children: [
      ...
      {
        path: '/Frm_Products/Frm_FamiliasProductos/Frm_FamiliasProductos',
        name: 'FamiliasProductos', // <--- Este nombre debe coincidir EXACTAMENTE con la 'ruta' en tu lista
