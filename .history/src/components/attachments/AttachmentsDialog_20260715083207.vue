<template>
    ...
    <Dialog v-model:visible="internalVisible" modal header="Documentos anexos" :style="{ width: '70rem' }"
        ...
        <div class="flex flex-column gap-3">
            ...
            <DataTable :value="documents" size="small" stripedRows class="w-full">
    ...
    <Dialog v-model:visible="previewVisible" modal :header="previewDocument?.name" :style="{ width: '60rem' }">


        <div v-if="previewDocument" class="preview-container">


            <iframe v-if="previewDocument.extension === 'pdf'" class="preview-frame" />


            <img v-else :src="previewDocument.url" class="preview-image" />
