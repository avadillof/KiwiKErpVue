        ...
        <template #content>
            ...
            <div v-else>
                ...
                <div class="field-row">
                    ...
                    <Tag :value="certificate.valid ? 'CERTIFICADO VÁLIDO' : 'CERTIFICADO CADUCADO'"
                        :severity="certificate.valid ? 'success' : 'danger'" />
...
const certificateStatus = computed(() => {
    ...
    if (props.certificate?.valid === true) {
        return {
    ...
    if (props.certificate?.valid === false) {
        return {
            text: 'CERTIFICADO CADUCADO',
            severity: 'danger'
        };
    }
