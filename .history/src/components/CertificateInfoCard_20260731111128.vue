...
const loadCertificateInfo = async () => {
    ...
    try {
        console.info(`${import.meta.env.VITE_API_URL}/WebGetCertificateInfo`);
        const response = await fetch(
            `${import.meta.env.VITE_API_URL}/WebGetCertificateInfo`,
            {
                ...
                body: JSON.stringify({
                    certificateId: certificate.pkid,
                    password: password
                })
            }
        );
        ...
        Object.assign(certificate, info);
        ...
        toast.add({
            ...
            detail: 'No se pudo abrir el certificado.',
