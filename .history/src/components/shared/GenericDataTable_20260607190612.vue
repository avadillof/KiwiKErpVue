...
.table-container {
  ...
  background: #ffffff;
  border-radius: 8px;
  overflow: hidden; /* Esto es vital para no desbordar */
  border: 1px solid #e5e7eb;
}

/* La tabla debe ser flexible y contenerse a sí misma */
:deep(.p-datatable) { 
  flex: 1; 
  display: flex; 
  flex-direction: column; 
  min-height: 0; /* Permite que se encoja para dejar espacio al paginador */
}

/* El wrapper interno de la tabla es el que tiene el scroll */
...
/* ... mantén el resto de estilos de los componentes internos igual ... */
</style>