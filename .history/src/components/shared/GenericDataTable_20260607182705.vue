...
.custom-dropdown-sm {
    height: 1.5rem !important;      /* Igual a tus botones */
    min-width: 3.5rem !important;  /* Ajustado al contenido */
    display: flex;
    align-items: center;
}

/* Ajusta el texto interno y el icono */
...
.custom-dropdown-sm :deep(.p-dropdown-trigger) {
    width: 1.5rem; /* Hace que la flecha sea pequeña */
}
</style>