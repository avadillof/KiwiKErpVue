...
const virtualScrollerOptions = {
  lazy: true,
  itemSize: 50, // Asegúrate de que tus filas tengan esta altura exacta en CSS
  delay: 200,
  numToleratedItems: 10, // Aumenta esto para que sea más sensible
  onLazyLoad: (event: any) => {
    console.log("Scroll detectado:", event); // SI ESTO NO SALE AL HACER SCROLL, EL PROBLEMA ES EL CSS
