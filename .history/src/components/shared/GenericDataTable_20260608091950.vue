...
const onSort = (event: any) => {
  // Asegúrate de enviar SOLO el nombre del campo como string
  // event.sortField es proporcionado por PrimeVue
  emit('sort', {
  ...
  first.value = 0;
  // fetchData usa los valores internos que ya actualizamos
