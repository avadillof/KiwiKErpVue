            ...
            <div class="kiwi-lookup-body">
                ...
                <div class="lookup-table">
                    ...
                    <DataTable :value="filteredItems" paginator :rows="rows" stripedRows responsiveLayout="scroll"
                        ...
                        @row-dblclick="selectRow" class="compact-table" >
...
.kiwi-lookup-body {
    display: flex;
    flex-direction: column;
    height: 100%; /* Ocupa el 100% del espacio del Dialog */
    min-height: 0;
    overflow: hidden;
}

/* El contenedor de la tabla debe crecer para ocupar el espacio restante */
.lookup-table {
    flex: 1;
    min-height: 0;
    overflow: hidden; /* Importante para que el DataTable controle su scroll */
}

/* Ajuste opcional para asegurar que el componente de PrimeVue llene el contenedor */
.compact-table {
    height: 100%;
}
