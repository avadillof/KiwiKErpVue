...
/* =========================
   SYNC SINGLE SOURCE OF TRUTH (Actualizado)
========================= */
watch(
    () => props.items,
    () => {
        // Solo intentamos re-buscar si actualmente NO hay un ítem seleccionado
        // o si el valor del modelo ha cambiado
        if (props.modelValue !== null && !selectedItem.value) {
            selectedItem.value =
