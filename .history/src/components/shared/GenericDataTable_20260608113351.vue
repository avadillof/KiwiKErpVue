<template>
  <div class="table-container">
    <div class="datatable-wrapper">
      ...
      <div v-if="filterable" class="search-bar">
         <IconField>
            <InputIcon class="pi pi-search" />
            <InputText v-model="searchQuery" placeholder="Buscar..." @input="onSearch" />
         </IconField>
      </div>
...
// Si es filtrable, añadimos el parámetro al endpoint
...
const onSearch = () => {
  first.value = 0; // Reiniciamos a la primera página al buscar
  fetchData(0, rows.value); // Recargamos datos
};
