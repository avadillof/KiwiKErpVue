<template>
  <div class="table-container">
    ...
    <div class="footer-container">
      <div class="info-bar">Total de registros: {{ totalRecords }}</div>
      <Paginator 
...
const props = defineProps<{ endpoint: string; selection?: any; initialRows?: number; }>();
...
const first = ref(0);
const rows = ref(props.initialRows || 400);
