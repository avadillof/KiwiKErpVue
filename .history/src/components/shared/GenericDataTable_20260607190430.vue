...
.table-container {
  /* En lugar de una altura fija, usamos el 100% de lo que el padre le asigne */
  height: 100%; 
  
  /* Flexbox se encarga de distribuir el espacio automáticamente */
  display: flex;
  flex-direction: column;
  min-height: 0; /* IMPRESCINDIBLE: permite que el componente se encoja si el padre lo necesita */
