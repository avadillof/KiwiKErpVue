  ...
  <div class="table-container">
    ...
    <div class="footer-container">
      <div class="info-bar">
        ...
        <div v-if="fechaFiltro==null" class="info-right-group">
...
async function fetchDataDateField(page: number,size: number,field: string,fechaFiltroFrom: [Date | null, Date | null] | null) {
  loading.value = true;

  try {

    fechaFiltro.value=fechaFiltroFrom;
    searchQuery.value = '';

    const params: any = { page, size };
    if (fechaFiltroFrom?.[0] && fechaFiltroFrom?.[1]) {
