  ...
  <div class="table-container">
    ...
    <div class="footer-container">
      <div class="info-bar">
        ...
        <span v-if="selectionCount > 0" class="separator"></span>
...
.info-bar {
  ...
  justify-content: space-between; /* Empuja el primer mensaje a la izq y el segundo a la der */
  padding: 0.25rem 1rem;
  font-size: 0.75rem;
  background: #ffffff;
  min-height: 2rem;       /* Asegura altura suficiente */
}
...
.separator {
  width: 1px;
  height: 1rem; /* Altura similar al texto */
  background-color: #d1d5db; /* Gris claro */
  margin: 0 0.25rem; /* Ajuste fino de espaciado */
