<template>
    <Dialog v-model:visible="visible" modal header="Historial de Conexiones" :style="{ width: '550px' }"
        ...
        <div class="reset-container">
            ...
            <TabView>
                <TabPanel header="Resumen" value="0">
                    <Timeline :value="recentEvents" align="alternate" class="mt-3">
                    </Timeline>
                </TabPanel>

                <TabPanel header="Historial Completo" value="1">
