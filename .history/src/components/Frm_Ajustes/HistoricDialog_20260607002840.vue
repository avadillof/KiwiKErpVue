...
const onTableScroll = (event: any) => {
    // Si tienes acceso al componente, PrimeVue suele tener un valor 'first' en el estado
    // Pero si no, usaremos la posición del scroll para calcular el índice
    const scrollTop = event.target.scrollTop;
    const rowHeight = 40; // Altura aproximada de tu fila en píxeles
