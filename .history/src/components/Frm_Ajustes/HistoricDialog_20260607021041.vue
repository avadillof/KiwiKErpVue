            ...
            <div class="main-grid">
                ...
                <div class="panel glass-effect">
                    ...
                    <div class="table-wrapper">
                        <GenericDataTable :key="apiUrl" :endpoint="apiUrl" ref="dataTableRef" dataKey="id" scrollHeight="flex"
...
// Sustituye tu parseToDateKey actual por esta:
const parseToDateKey = (dateStr: string): string => {
    // Si la fecha ya viene como "2026-06-07", el split es '-'
    // Si viene con hora "2026-06-07 01:32:51", tomamos solo la parte de la fecha
...
const handleDataLoaded1 = (data: any[], total: number) => {
    // 1. No concatenes, simplemente asigna. 
    // La tabla ya sabe qué página está mostrando gracias al evento lazy.
    
    allLoadedData.value = data; 
    totalRecordsFromAPI.value = total;
    
    // 2. Solo actualiza la gráfica si es estrictamente necesario, 
    // pero no fuerces una actualización de la tabla.
    updateChart(allLoadedData.value);
};
