<template>
    <Dialog v-model:visible="visible" modal :header="'Análisis de Actividad para ' + selectedUserName"
            ...
            <div class="main-grid">
                ...
                <div class="panel glass-effect flex-1">
                    ...
                    <div class="table-container-wrapper">
                        ...
                        <GenericDataTable ref="tableRef" :endpoint="apiUrl" :showPaginator="true" :filterable="true"
                            selectionMode="single" v-model:selection="ctrl.miSeleccion"
                            @row-select="ctrl.handleRowSelect" @data-loaded="ctrl.handleDataLoaded" :showActions="true">
        ...
        <OverlayPanel ref="opDateFilter">
            <DateRangePicker v-model="ctrl.fechaFiltro" placeholder="Rango de fecha" style="width: 250px;" />
        </OverlayPanel>
