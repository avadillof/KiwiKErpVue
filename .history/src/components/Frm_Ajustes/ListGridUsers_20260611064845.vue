      ...
      <Column field="lastConexion" sortable style="width: 15%">
        <template #header>
          <div class="flex align-items-center justify-content-between w-full">
            ...
            <Button icon="pi pi-filter" text rounded size="small" />
          </div>
        </template>
...
<OverlayPanel ref="opDateFilter">
  <DateRangePicker v-model="fechaFiltro" />
  <Button label="Aplicar" size="small" class="w-full mt-2" @click="applyFilter" />
</OverlayPanel>
