            ...
            <div class="main-grid">
                ...
                <div class="panel glass-effect">
                    ...
                    <div class="table-wrapper">
                        <GenericDataTable :endpoint="apiUrl" ref="dataTableRef" key="data.length" dataKey="id"
                            scrollHeight="flex" v-model:selection="selectedRow" @data-loaded="handleDataLoaded"
                            ...
                            <Column field="date" header="Fecha">
                                <template #body="slotProps">
                                    ...
                                    <span v-else class="date-badge">
                                        <small class="text-gray-400 mr-2">[{{ slotProps.index }}]</small>
...
/* Obligatorio para que el VirtualScroller calcule el espacio disponible */
.table-wrapper {
    height: 450px !important;
    /* Ajusta a tu gusto, pero debe ser fijo */
    overflow: hidden;
}
...
/* Fuerza a las filas a medir exactamente lo mismo que el itemSize: 50 */
