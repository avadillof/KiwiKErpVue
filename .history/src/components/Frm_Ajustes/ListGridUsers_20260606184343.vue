      ...
      <Column header="Usuario" field="userDsName" sortable style="width: 25%">
        <template #body="slotProps">
          <div class="flex align-items-center gap-2">
            <Avatar :label="getInitials(slotProps.data.userDsName)" style="background-color:#dee9fc; color: #1a2544"
              shape="circle" />
      ...
      <Column field="userDtLastAccess" header="Última Conexión" sortable style="width: 20%">
        <template #body="slotProps">
          <div class="flex align-items-center gap-2">
            ...
            <span>{{ HelperDates.formatDateFromLocale(slotProps.data.userDtLastAccess) }}</span>
          </div>
        </template>
      </Column>
...
import { HelperString} from '../../libs/HelperDates';
