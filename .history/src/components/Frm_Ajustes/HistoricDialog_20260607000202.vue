    ...
    <Dialog v-model:visible="visible" modal header="Análisis de Actividad" 
        ...
        <div class="main-container">
            <div class="flex flex-row gap-4 h-full">
                ...
                <div class="activity-chart flex-none w-5">
                    <h5 class="text-center">Actividad (2 meses)</h5>
                    <div style="height: 400px;">
                        <Chart type="line" :data="chartData" :options="chartOptions" />
                    </div>
                </div>

                <div class="table-container flex-grow-1 overflow-hidden">
...
/* Forzamos al contenedor de la tabla para que sea flexible */
.table-container {
    display: flex;
    flex-direction: column;
    min-width: 0; /* Importante para que el flexbox no se rompa */
}

/* Ajuste específico para que la tabla rellene su contenedor flex */
:deep(.p-datatable) {
    display: flex;
    flex-direction: column;
    height: 100%;
