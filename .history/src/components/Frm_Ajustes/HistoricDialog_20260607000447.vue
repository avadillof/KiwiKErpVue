<template>
    <Dialog v-model:visible="visible" modal header="Análisis de Actividad y Conexiones" 
        ...
        <div class="main-container flex flex-row gap-4 h-full p-2">
            
            <div class="chart-panel w-7 flex-none p-3 shadow-1 border-round-lg border-1 surface-border">
                <h5 class="text-center mb-3">Tendencia de Conexiones (2 meses)</h5>
                <div style="height: 450px;">
                    <Chart type="line" :data="chartData" :options="chartOptions" />
                </div>
            </div>

            <div class="table-panel w-5 flex-grow-1 p-3 shadow-1 border-round-lg border-1 surface-border overflow-hidden">
        ...
        <div class="flex justify-content-end mt-3 px-3">
...
<style scoped>
.main-container { 
    height: calc(100% - 50px); /* Ajuste para el botón de cerrar */
}

/* Estilo para el "Border Bonito" */
...
/* Ajuste para que la tabla ocupe bien el espacio del panel */
.table-panel {
    display: flex;
