<template>
    <Dialog v-model:visible="visible" modal header="Análisis de Actividad" :style="{ width: '11000px', height: '500px' }"
            ...
            <div class="panel table-panel">
                ...
                <div class="table-wrapper">
                    <GenericDataTable :key="apiUrl" :endpoint="apiUrl" ref="dataTableRef" scrollHeight="flex"
                        @data-loaded="handleDataLoaded" @lazy-load="onTableLazyLoad">
