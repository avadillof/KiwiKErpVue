...
>
    <Column field="date" style="width: 100%">
        ...
        <template #body="slotProps">
            <div v-if="!slotProps.data || slotProps.data.isEmpty" class="loading-placeholder">
                <i class="pi pi-spinner pi-spin"></i> Cargando...
            </div>

            <span v-else class="date-badge">
    <!-- El número de fila para contrastar -->
...
.table-wrapper {
    height: 450px !important; /* Ajusta a tu gusto, pero debe ser fijo */
    overflow: hidden;
}
