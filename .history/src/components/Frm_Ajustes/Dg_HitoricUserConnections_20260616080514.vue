<template>
    <Dialog v-model:visible="visible" modal :header="'Análisis de Actividad para ' + selectedUserName"
            ...
            <div class="main-grid">
                ...
                <div class="panel glass-effect flex-1">
                    ...
                    <div class="table-container-wrapper">
                        ...
                        <GenericDataTable ref="tableRef" :endpoint="apiUrl" :showPaginator="true" :filterable="false"
                            ...
                            @filterdate="ctrl.handleFilterDate"
                            >
                            ...
                            <Column field="date" sortable>
                                ...
                                <template #header>
                                    <div class="flex align-items-center justify-content-between w-full">
                                        <span><b>Fecha</b></span>
                                        <Button  :severity="ctrl.fechaFiltroByDate ? 'danger' : 'secondary'"  icon="pi pi-filter"  rounded size="small" @click.stop="onFilterByDateClick($event) " />
                                    </div>
                                </template>
        ...
        <OverlayPanel ref="opDateFilter" appendTo="body" >
            <DateRangePicker  v-model="ctrl.fechaFiltroByDate" />
        </OverlayPanel>
...
const onFilterByDateClick = (event: any) => {
      opDateFilterByDate.value?.toggle(event);
};
