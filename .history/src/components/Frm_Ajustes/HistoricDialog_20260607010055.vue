...
.main-grid {
  display: grid;
  /* Mantenemos las columnas, pero ahora el contenedor permite más flexibilidad */
  grid-template-columns: 1fr 0.45fr;
  gap: 1.5rem;
  /* Aumentamos la altura total del grid */
  height: 480px; 
  margin-bottom: 1rem;
}
...
/* Forzamos que el wrapper del chart ocupe todo el espacio disponible */
.chart-wrapper {
  flex-grow: 1;
  min-height: 0;
  display: flex;
...
/* Aseguramos que el componente Chart de PrimeVue se expanda */
.chart-wrapper > div {
  width: 100% !important;
