                            ...
                            <Column field="date" sortable>
                                ...
                                <template #header>
                                    <div class="flex align-items-center justify-content-between w-full">
                                        <span><b>Fecha</b></span>
                                        <Button  :severity="ctrl.fechaFiltroByDate ? 'danger' : 'secondary'"  icon="pi pi-filter"  rounded size="small" @click.stop="onFilterClick($event) " />
                                    </div>
                                </template>
