...
.chart-container { 
    flex: 1.5; /* Esto le da un 50% más de peso vertical que a otros elementos hermanos si los hubiera */
    min-height: 1400px; /* <--- Esto es lo que realmente "alarga" la gráfica */
    position: relative;
    width: 100%;
...
const chartOptions = ref({
    responsive: true,
    maintainAspectRatio: true, // Fundamental
    layout: {
        padding: {
            top: 20,
            bottom: 20
    ...
    scales: {
        ...
        x: {
            grid: {
                display: false // Limpia el gráfico visualmente
            }
        }
    }
});
