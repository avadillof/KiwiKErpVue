                    ...
                    <div class="stat-content">
                        ...
                        <strong class="stat-value">{{ stats.totalRecords }}</strong>
                            ...
                            <strong class="stat-value">
                                ...
                                formatThousands(new Intl.NumberFormat('es-ES').format(Number(stats.totalRecords)))

                                {{ new Intl.NumberFormat('es-ES').format(Number(stats.totalRecords)) }}
                                {{ new Intl.NumberFormat('es-ES', { minimumGroupingDigits: 1}).format(4500)}}
