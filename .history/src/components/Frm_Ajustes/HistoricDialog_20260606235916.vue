<template>
    <Dialog v-model:visible="visible" modal header="Análisis de Actividad y Conexiones" :style="{ width: '800px', height: '80vh' }"
        class="kiwik-dialog" :contentStyle="{ display: 'flex', flexDirection: 'column', height: '100%', overflow: 'hidden' }">

        <div class="reset-container flex flex-column h-full overflow-hidden">
            <div class="activity-chart mb-4 flex-none">
            ...
            <div class="kiwik-separator mb-3 flex-none"></div>
            ...
            <div class="flex justify-content-end mt-3 flex-none">
