<template>
    <Dialog v-model:visible="ctrl.visible.value" modal
        :header="'Análisis de Actividad para ' + ctrl.selectedUserName.value" :style="{ width: '85%', height: '95vh' }"
        ...
        <div class="reset-container">
                ...
                <div class="stat-card">
                    ...
                    <div class="stat-content">
                        ...
                        <strong class="stat-value">
                            {{ ctrl.HelperString.formatThousands(ctrl.stats.value.totalRecords) }}
                        </strong>
                    </div>
                </div>
                <div class="stat-card">
                    ...
                    <div class="stat-content">
                        ...
                        <strong class="stat-value">{{ ctrl.stats.value.dailyAverage }}</strong>
                    </div>
                </div>
                <div class="stat-card">
            ...
            <div class="main-grid">
                ...
                <div class="panel glass-effect flex-1">
                    ...
                    <div class="table-container-wrapper">
                        ...
                        <GenericDataTable ref="tableRef" :endpoint="ctrl.apiUrl.value" :showPaginator="true"
                            :filterable="true" selectionMode="single" v-model:selection="ctrl.miSeleccion"
                            ...
                            <template #headerActions>
                                ...
                                <Menu ref="menu" :model="ctrl.opcionesMenu.value" popup />
                            </template>
            ...
            <div class="flex justify-content-end">
                <Button label="Cerrar" @click="ctrl.visible.value = false" />
            </div>
        </div>
    </Dialog>
</template>
