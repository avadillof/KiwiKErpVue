  ...
  <div class="card" style="height: 500px; display: flex; flex-direction: column;">
    ...
    <GenericDataTable style="min-height: 400px;" ref="tableRef" dataKey="userKyId" :endpoint="apiUrl"
      ...
      <template #headerActions>
        <Button icon="pi pi-ellipsis-v" severity="secondary" text rounded class="mr-2" @click="openMenuTable($event)" />
      ...
      <Column field="userDsCode" header="Código" sortField="userDsCode" sortable style="width: 15%">

      </Column>


      <Column header="Usuario" field="name" sortField="userDsName" sortable style="width: 25%">
      ...
      <Column field="groupName" header="Rol"   sortField="userGroup.descriptionEs" sortable style="width: 20%">
        <template #body="slotProps">
