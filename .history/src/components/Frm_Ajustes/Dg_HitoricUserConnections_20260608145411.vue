<template>
    <Dialog v-model:visible="useDgHistoricUserConnectionsController.visible" modal :header="'Análisis de Actividad para ' + selectedUserName"
                        ...
                        <GenericDataTable 
                            ...
                            :showActions="true"   >
                                <template #headerActions>
                                    ...
                                    <Menu ref="menu" :model="ctrl.opcionesMenu" popup />
                                </template>
