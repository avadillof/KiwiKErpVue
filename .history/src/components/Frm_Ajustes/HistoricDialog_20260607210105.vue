...
const formatThousands = (value: any) => {
  // 1. Convertimos a número, quitando cualquier carácter que no sea número
  // Esto asegura que si viene un string "1573", lo tome como 1573
  const numericValue = Number(value); 

  // 2. Formateamos
  return new Intl.NumberFormat('es-ES', {
    minimumGroupingDigits: 1
  } as any).format(numericValue || 0);
};
