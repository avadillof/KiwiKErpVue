<template>
    <Dialog v-model:visible="ctrl.visible.value" modal :header="'Análisis de Actividad para ' + ctrl.selectedUserName.value"
...
<script setup lang="ts">
   ...
   import { GerericDataTable} from '../shared/GenericDataTable.vue'
   const ctrl = useDgHistoricUserConnectionsController();
   defineExpose({ open: ctrl.open });
