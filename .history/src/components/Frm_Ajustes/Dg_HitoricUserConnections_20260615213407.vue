<template>
    <Dialog v-model:visible="visible" modal :header="'Análisis de Actividad para ' + selectedUserName"
                            ...
                            <Column field="date" sortable>
                                ...
                                <template #header>
                                    <div class="flex align-items-center justify-content-between w-full">
                                        <span><b>Fecha</b></span>
                                        <Button icon="pi pi-filter" text rounded size="small" @click.stop="onFilterClick($event)" />
                                    </div>
                                </template>
        ...
        <OverlayPanel ref="opDateFilter" appendTo="body"  @hide="clearDateFilter">
