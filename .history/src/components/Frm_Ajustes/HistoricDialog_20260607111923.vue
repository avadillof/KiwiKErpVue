                ...
                <div class="panel glass-effect">
                    ...
                    <div class="table-wrapper">
                        <GenericDataTable :endpoint="apiUrl" ref="dataTableRef" dataKey="id"
                             v-model:selection="selectedRow" @data-loaded="handleDataLoaded"
                            @row-select="onRowSelect">

                            <Column field="date" header="Fecha de Conexión" style="height: 50px;"> <template #loading>
                                    <div style="height: 50px; display: flex; align-items: center; padding: 0 1rem;">
...
.table-wrapper {
    flex-grow: 1;
    min-height: 0; /* IMPORTANTE: Esto permite que los hijos tengan altura porcentual */
    display: flex;
    flex-direction: column;
}

/* Forzar al datatable a adaptarse al contenedor padre */
:deep(.p-datatable) {
    display: flex;
    flex-direction: column;
    height: 100% !important; /* Llena el 100% del table-wrapper */
}
