<template>
    <Dialog v-model:visible="visible" modal header="Historial de Conexiones" 
        ...
        <div class="reset-container"> <div class="reset-header">
...
<style scoped>
/* Asegúrate de que las clases kiwik-dialog, reset-container, etc., 
   estén definidas en tu CSS global o aquí si son específicas */
.reset-container {
    padding: 1rem;
}
.reset-header {
