...
export function DashboardController() {
    ...
    const listaModulos = [
        { id: 'ventas', nombre: 'Ventas', descripcion: 'Gestiona el circuito completo desde el presupuesto hasta el cobro, con trazabilidad, documentación e indicadores en tiempo real.', funcionalidades: ['Entidades, artículos y tarifas', 'Presupuestos', 'Pedidos de venta', 'Albaranes', 'Facturas, vencimientos y cobros', 'Widgets e indicadores'], icono: 'pi pi-briefcase', ruta: 'Ventas', colorIcono: '#2875b6', bgIcono: '#e9f4fc', disponible: true },
