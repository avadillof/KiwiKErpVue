...
const gruposVentas: Array<{ id: string; nombre: string; descripcion: string; icono: string; opciones: OpcionVenta[] }> = [
  ...
  },
  {
    ...
    opciones: [
      ...
      { id: 'facturas', nombre: 'Facturas de venta', descripcion: 'Factura desde pedidos, albaranes o manualmente; consulta cobros, trazabilidad y documentación AEAT.', icono: 'pi pi-receipt', ruta: 'Facturas', color: '#ffffff', fondo: 'linear-gradient(135deg, #e46e8e, #b74267)', disponible: true, funciones: ['Cobros e historial', 'Expedientes AEAT'] },
