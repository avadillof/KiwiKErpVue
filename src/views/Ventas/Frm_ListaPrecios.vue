...
<style scoped>
.prices-page { --kiwi: #9cc10a; --kiwi-dark: #648506; display: flex; width: 100%; min-height: calc(100dvh - 66px); flex-direction: column; padding: 18px 16px 72px; color: #243044; background: rgba(247,248,250,.58); }
