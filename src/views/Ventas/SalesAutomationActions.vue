<template>
  <div class="automation-actions" :class="{ 'invoice-actions': module === 'invoices' }">
    <Button :label="module === 'invoices' ? 'Enviar recordatorio de vencimientos' : module === 'quotes' ? 'Enviar recordatorio interno' : 'Enviar recordatorio de entregas'" icon="pi pi-send" severity="secondary" outlined :size="module === 'invoices' ? undefined : 'small'" :disabled="busy || disabled" v-tooltip.bottom="module === 'invoices' ? 'Aviso interno a los usuarios seleccionados en Ajustes con saldos pendientes de facturas aceptadas. Nunca se envía al contacto del cliente.' : module === 'quotes' ? 'Aviso interno al usuario creador del presupuesto. Nunca se envía al contacto del cliente.' : 'Aviso a los responsables de los pedidos pendientes.'" @click="open(module === 'invoices' ? 'invoice' : module === 'quotes' ? 'reminder' : 'delivery')" />
