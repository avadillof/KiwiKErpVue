...
const isEditable = computed(() => isOrder.value ? (!quote.value.pkid || (!quote.value.locked && !['Completado / Completed', 'Cancelado / Canceled', 'Realizado / Done'].includes(quote.value.state))) : (!quote.value.pkid || ['Para Aprobar / To Approved Estimation', 'Enviado / Sended'].includes(quote.value.state)));
