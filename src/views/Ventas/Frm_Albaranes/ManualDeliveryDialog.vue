...
const newLine = () => ({ productId: null as number|null, productLabel: '', description: '', quantity: 1, priceUnit: 0, tax: 0, uomId: null as number|null, pricingSource:'',pricingError:'',pricingPending:false });
